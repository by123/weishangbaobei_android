...
public class Iso639 {
    ...
    static {
        ...
        doublePut("aa", "aar");
        doublePut("af", "afr");
        doublePut(SocializeProtocolConstants.PROTOCOL_KEY_AK, "aka");
        doublePut("sq", "sqi");
        doublePut("am", "amh");
        doublePut("ar", "ara");
        doublePut("an", "arg");
        ...
        doublePut("nl", "nld");
        doublePut("dz", "dzo");
        doublePut(SocializeProtocolConstants.PROTOCOL_KEY_EN, "eng");
        doublePut("eo", "epo");
        doublePut("et", "est");
        doublePut("ee", "ewe");
        doublePut("fo", "fao");
        doublePut("fj", "fij");
        doublePut("fi", "fin");
        doublePut(SocializeProtocolConstants.PROTOCOL_KEY_FR, "fra");
        doublePut("ff", "ful");
        doublePut("gl", "glg");
        doublePut("ka", "kat");
        doublePut(SocializeProtocolConstants.PROTOCOL_KEY_DE, "deu");
        doublePut("el", "ell");
        doublePut("gn", "grn");
        doublePut("gu", "guj");
        doublePut("ht", "hat");
