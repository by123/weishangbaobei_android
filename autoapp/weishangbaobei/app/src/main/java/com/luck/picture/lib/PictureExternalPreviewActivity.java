...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            if (localMedia != null) {
                ...
                if (!isGif || localMedia.isCompressed()) {
                    ...
                    Glide.with(PictureExternalPreviewActivity.this).load(str).asBitmap().into(new SimpleTarget<Bitmap>(480, BannerConfig.DURATION) {
                        ...
                        public void onResourceReady(Bitmap bitmap, GlideAnimation<? super Bitmap> glideAnimation) {
                            PictureExternalPreviewActivity.this.dismissDialog();
                            if (isLongImg) {
                                PictureExternalPreviewActivity.this.displayLongPic(bitmap, subsamplingScaleImageView2);
                            } else {
                    ...
                    Glide.with(PictureExternalPreviewActivity.this).load(str).asGif().override(480, BannerConfig.DURATION).priority(Priority.HIGH).diskCacheStrategy(DiskCacheStrategy.NONE).listener(new RequestListener<String, GifDrawable>() {
                ...
                photoView.setOnLongClickListener(new View.OnLongClickListener() {
                    /* JADX WARNING: type inference failed for: r1v1, types: [com.luck.picture.lib.PictureExternalPreviewActivity, android.app.Activity] */
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [android.content.Context, com.luck.picture.lib.PictureExternalPreviewActivity] */
    /* access modifiers changed from: private */
    public void showDownLoadDialog(final String str) {
        ...
        ((Button) customDialog.findViewById(R.id.btn_commit)).setOnClickListener(new View.OnClickListener() {
            /* JADX WARNING: type inference failed for: r5v6, types: [android.content.Context, com.luck.picture.lib.PictureExternalPreviewActivity] */
            public void onClick(View view) {
                PictureExternalPreviewActivity.this.showPleaseDialog();
                if (PictureMimeType.isHttp(str)) {
                    ...
                    try {
                        ? r5 = PictureExternalPreviewActivity.this;
                        String createDir = PictureFileUtils.createDir(r5, System.currentTimeMillis() + PictureMimeType.PNG, PictureExternalPreviewActivity.this.directory_path);
