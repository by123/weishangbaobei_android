...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        final int i5 = i;
        final LocalMedia localMedia3 = localMedia;
        viewHolder2.contentView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (!new File(str2).exists()) {
                    ToastManage.s(PictureImageGridAdapter.this.context, PictureMimeType.s(PictureImageGridAdapter.this.context, i4));
                    return;
                }
                boolean z = true;
                int i = PictureImageGridAdapter.this.showCamera ? i5 - 1 : i5;
                if ((i4 != 1 || !PictureImageGridAdapter.this.enablePreview) && ((i4 != 2 || (!PictureImageGridAdapter.this.enablePreviewVideo && PictureImageGridAdapter.this.selectMode != 1)) && (i4 != 3 || (!PictureImageGridAdapter.this.enablePreviewAudio && PictureImageGridAdapter.this.selectMode != 1)))) {
                    z = false;
                }
                if (z) {
                    PictureImageGridAdapter.this.imageSelectChangedListener.onPictureClick(localMedia3, i);
                } else {
                    PictureImageGridAdapter.this.changeCheckboxState(viewHolder2, localMedia3);
                }
            }
        });
    }
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View view) {
            ...
            if (PictureImageGridAdapter.this.mimeType == PictureMimeType.ofAudio()) {
            ...
            this.tv_title_camera.setText(str);
        }
    }
    ...
    public void changeCheckboxState(ViewHolder viewHolder, LocalMedia localMedia) {
        ...
        if (this.selectImages.size() >= this.maxSelectNum) {
            if (pictureType.startsWith("image")) {
                str = this.context.getString(R.string.picture_message_max_num, new Object[]{Integer.valueOf(this.maxSelectNum)});
            } else {
                str = this.context.getString(R.string.picture_message_video_max_num, new Object[]{Integer.valueOf(this.maxSelectNum)});
            }
            ToastManage.s(this.context, str);
            return;
        }
        if (isSelected) {
