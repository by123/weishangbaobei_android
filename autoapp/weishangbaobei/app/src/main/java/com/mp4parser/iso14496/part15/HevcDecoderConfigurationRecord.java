...
public class HevcDecoderConfigurationRecord {
    ...
    public static class Array {
        ...
        public int hashCode() {
            return ((((((this.array_completeness ? 1 : 0) * true) + (this.reserved ? 1 : 0)) * 31) + this.nal_unit_type) * 31) + (this.nalUnits != null ? this.nalUnits.hashCode() : 0);
        }
