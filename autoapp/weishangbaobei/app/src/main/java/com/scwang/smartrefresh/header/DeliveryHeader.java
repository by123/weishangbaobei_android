...
public class DeliveryHeader extends InternalAbstract implements RefreshHeader {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int i3 = width / 2;
        this.mBoxDrawable.getBounds().offsetTo(i3 - (this.mBoxDrawable.getBounds().width() / 2), ((((this.mHeaderHeight / 2) - this.mBoxDrawable.getBounds().height()) + i2) - Math.min((this.mHeaderHeight / 2) - this.mBoxDrawable.getBounds().height(), DensityUtil.dp2px(this.mAppreciation * 100.0f))) - (this.mBoxDrawable.getBounds().height() / 4));
        this.mBoxDrawable.draw(canvas);
        if (this.mState == RefreshState.Refreshing || this.mState == RefreshState.RefreshFinish) {
            Rect bounds = this.mUmbrellaDrawable.getBounds();
            this.mUmbrellaDrawable.getBounds().offsetTo(i3 - (bounds.width() / 2), ((i2 - this.mHeaderHeight) + Math.min(this.mHeaderHeight, DensityUtil.dp2px(this.mAppreciation * 100.0f))) - bounds.height());
