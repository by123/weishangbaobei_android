...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public float getMinProgressArc(Ring ring) {
        ...
        Double.isNaN(d);
        return (float) Math.toRadians(d / (ring.mRingCenterRadius * 6.283185307179586d));
    }
    ...
    public void applyFinishTranslation(float f, Ring ring) {
        ...
        setProgressRotation(ring.mStartingRotation + ((((float) (Math.floor((double) (ring.mStartingRotation / MAX_PROGRESS_ARC)) + 1.0d)) - ring.mStartingRotation) * f));
    }
