    ...
    public static class PathDataNode {
        ...
        private static void addCommand(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            ...
            L_0x02f0:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.scwang.smartrefresh.header.internal.pathview.PathParser.PathDataNode.addCommand(android.graphics.Path, float[], char, char, float[]):void");
        }
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d23 != 0.0d) {
                ...
                Double.isNaN(d11);
                double d29 = d * d11;
                arcToBezier(path, (d28 * cos) - (d29 * d27), (d28 * d27) + (d29 * cos), d16, d11, d5, d10, radians, atan2, atan22);
            }
        }
