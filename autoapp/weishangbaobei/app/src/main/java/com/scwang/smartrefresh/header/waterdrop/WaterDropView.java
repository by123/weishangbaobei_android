...
public class WaterDropView extends View {
    ...
    public void onMeasure(int i, int i2) {
        super.setMeasuredDimension(((this.mMaxCircleRadius + STROKE_WIDTH) * 2) + getPaddingLeft() + getPaddingRight(), View.resolveSize(((int) Math.ceil((double) (this.bottomCircle.y + this.bottomCircle.radius + ((float) (STROKE_WIDTH * 2))))) + getPaddingTop() + getPaddingBottom(), i2));
    }
    ...
    private void makeBezierPath() {
        ...
        if (this.bottomCircle.y > this.topCircle.y + ((float) DensityUtil.dp2px(1.0f))) {
            ...
            this.mPath.quadTo(this.bottomCircle.x - this.bottomCircle.radius, (this.bottomCircle.y + this.topCircle.y) / 2.0f, (float) (d7 - (d8 * cos3)), f2);
    ...
    public void updateCompleteState(float f) {
        ...
        this.bottomCircle.radius = f2;
        this.bottomCircle.y = this.topCircle.y + f3;
    }
    ...
    public void updateCompleteState(int i) {
        ...
        float max = Math.max(CropImageView.DEFAULT_ASPECT_RATIO, f2 - f);
        double d = (double) ((float) (this.mMaxCircleRadius - this.mMinCircleRadius));
        Double.isNaN(d);
        float pow = (float) (d * (1.0d - Math.pow(100.0d, (double) ((-max) / ((float) DensityUtil.dp2px(200.0f))))));
        this.topCircle.radius = ((float) this.mMaxCircleRadius) - (pow / 4.0f);
        this.bottomCircle.radius = ((float) this.mMaxCircleRadius) - pow;
