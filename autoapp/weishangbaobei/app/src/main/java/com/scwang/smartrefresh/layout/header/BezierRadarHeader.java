...
public class BezierRadarHeader extends InternalAbstract implements RefreshHeader {
    ...
    public void drawWave(Canvas canvas, int i) {
        ...
        this.mPath.lineTo(f2, CropImageView.DEFAULT_ASPECT_RATIO);
    ...
    public void drawDot(Canvas canvas, int i, int i2) {
        ...
        if (f > CropImageView.DEFAULT_ASPECT_RATIO) {
            ...
            float f3 = (float) (i / 7);
            float f4 = 1.0f;
            float f5 = (this.mDotFraction * f3) - (this.mDotFraction > 1.0f ? ((this.mDotFraction - 1.0f) * f3) / this.mDotFraction : CropImageView.DEFAULT_ASPECT_RATIO);
            float f6 = (float) i2;
            float f7 = 2.0f;
            ...
            int i3 = 0;
            while (i3 < 7) {
                float f9 = (((float) i3) + f4) - 4.0f;
                Paint paint = this.mPaint;
                double abs = (double) (this.mDotAlpha * (f4 - ((Math.abs(f9) / 7.0f) * f7)) * 255.0f);
                ...
                canvas.drawCircle((((float) (i / 2)) - (f10 / 2.0f)) + (f9 * f5), f8 / 2.0f, f10, this.mPaint);
                i3++;
                f4 = 1.0f;
                f7 = 2.0f;
            }
