...
public class StatConfig {
    ...
    static void b(android.content.Context r6, org.json.JSONObject r7) {
        /*
            ...
            boolean r0 = com.tencent.wxop.stat.common.l.c((java.lang.String) r7)     // Catch:{ Exception -> 0x01b6 }
        ...
        L_0x003e:
            if (r7 <= 0) goto L_0x0077
            boolean r2 = isDebugEnable()     // Catch:{ Exception -> 0x01b6 }
            if (r2 == 0) goto L_0x005e
            com.tencent.wxop.stat.common.StatLogger r2 = p     // Catch:{ Exception -> 0x01b6 }
            ...
            r2.i(r3)     // Catch:{ Exception -> 0x01b6 }
        L_0x005e:
            ...
            com.tencent.wxop.stat.common.q.b((android.content.Context) r6, (java.lang.String) r7, (long) r2)     // Catch:{ Exception -> 0x01b6 }
            setEnableStatService(r1)     // Catch:{ Exception -> 0x01b6 }
            com.tencent.wxop.stat.common.StatLogger r7 = p     // Catch:{ Exception -> 0x01b6 }
            java.lang.String r2 = "MTA is disable for current SDK version"
            r7.warn(r2)     // Catch:{ Exception -> 0x01b6 }
        L_0x0077:
            ...
            r7.i(r1)     // Catch:{ Exception -> 0x01b6 }
            r1 = 1
        L_0x008a:
        ...
        L_0x00aa:
            ...
            java.lang.String r3 = com.tencent.wxop.stat.common.l.h(r6)     // Catch:{ Exception -> 0x01b6 }
            boolean r7 = a((org.json.JSONObject) r0, (java.lang.String) r7, (java.lang.String) r3)     // Catch:{ Exception -> 0x01b6 }
        ...
        L_0x0186:
            ...
            java.lang.String r3 = getLocalMidOnly(r6)     // Catch:{ Exception -> 0x01b6 }
            boolean r7 = a((org.json.JSONObject) r0, (java.lang.String) r7, (java.lang.String) r3)     // Catch:{ Exception -> 0x01b6 }
            ...
            java.lang.String r6 = getLocalMidOnly(r6)     // Catch:{ Exception -> 0x01b6 }
            r0.append(r6)     // Catch:{ Exception -> 0x01b6 }
            java.lang.String r6 = r0.toString()     // Catch:{ Exception -> 0x01b6 }
            r7.i(r6)     // Catch:{ Exception -> 0x01b6 }
            r1 = 1
        L_0x01aa:
            if (r1 == 0) goto L_0x01b5
            java.lang.String r6 = "2.0.4"
            long r6 = com.tencent.wxop.stat.common.l.b((java.lang.String) r6)     // Catch:{ Exception -> 0x01b6 }
            a((long) r6)     // Catch:{ Exception -> 0x01b6 }
        L_0x01b5:
            return
        L_0x01b6:
            r6 = move-exception
            com.tencent.wxop.stat.common.StatLogger r7 = p
            r7.e((java.lang.Throwable) r6)
            return
        */
