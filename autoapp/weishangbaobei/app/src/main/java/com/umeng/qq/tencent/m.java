...
public class m extends h {
    ...
    private void c(Activity activity, Bundle bundle, j jVar) {
        ...
        String string4 = bundle2.getString(a.h);
        String string5 = bundle2.getString(a.j);
        ...
        if (b == null) {
            b = bundle2.getString(a.i);
        }
        String string7 = bundle2.getString(a.b);
        String b2 = this.b.b();
        String d = this.b.d();
