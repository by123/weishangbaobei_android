...
public class AlipayWithdrawalsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v11, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r1v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r1v19, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$5] */
    /* JADX WARNING: type inference failed for: r1v23, types: [com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v28, types: [com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$7, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v33, types: [com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$8, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v42, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AlipayWithdrawalsActivity_ViewBinding$9] */
    @UiThread
