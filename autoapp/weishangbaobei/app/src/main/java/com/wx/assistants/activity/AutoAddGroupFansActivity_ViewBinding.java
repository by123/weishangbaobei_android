...
public class AutoAddGroupFansActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.AutoAddGroupFansActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v16, types: [com.wx.assistants.activity.AutoAddGroupFansActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v22, types: [com.wx.assistants.activity.AutoAddGroupFansActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v27, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddGroupFansActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r1v36, types: [com.wx.assistants.activity.AutoAddGroupFansActivity_ViewBinding$5, android.view.View$OnClickListener] */
    @UiThread
