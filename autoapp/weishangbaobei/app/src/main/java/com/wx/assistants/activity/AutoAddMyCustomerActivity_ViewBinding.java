...
public class AutoAddMyCustomerActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v5, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddMyCustomerActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v9, types: [com.wx.assistants.activity.AutoAddMyCustomerActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v13, types: [com.wx.assistants.activity.AutoAddMyCustomerActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v18, types: [com.wx.assistants.activity.AutoAddMyCustomerActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v24, types: [com.wx.assistants.activity.AutoAddMyCustomerActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v30, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddMyCustomerActivity_ViewBinding$6] */
    @UiThread
