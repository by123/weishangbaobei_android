...
public class AutoAddSearchActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.AutoAddSearchActivity] */
    @Subscribe
            ...
            startCheck("65", true, new BaseActivity.OnStartCheckListener() {
                public void checkEnd() {
                    ApiWrapper.getInstance().getPassiveCardList(1, AutoAddSearchActivity.this.defaultNum, new ApiWrapper.CallbackListener<ConmdListBean>() {
                        ...
                        /* JADX WARNING: type inference failed for: r4v4, types: [android.content.Context, com.wx.assistants.activity.AutoAddSearchActivity] */
                        /* JADX WARNING: type inference failed for: r4v11, types: [android.content.Context, com.wx.assistants.activity.AutoAddSearchActivity] */
