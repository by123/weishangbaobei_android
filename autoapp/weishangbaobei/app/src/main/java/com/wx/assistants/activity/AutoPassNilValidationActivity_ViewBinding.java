...
public class AutoPassNilValidationActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.AutoPassNilValidationActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v8, types: [com.wx.assistants.activity.AutoPassNilValidationActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v13, types: [com.wx.assistants.activity.AutoPassNilValidationActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v20, types: [com.wx.assistants.activity.AutoPassNilValidationActivity_ViewBinding$4, android.view.View$OnClickListener] */
    @UiThread
