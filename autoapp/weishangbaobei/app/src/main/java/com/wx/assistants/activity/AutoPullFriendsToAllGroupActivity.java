...
public class AutoPullFriendsToAllGroupActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.AutoPullFriendsToAllGroupActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [android.content.Context, com.wx.assistants.activity.AutoPullFriendsToAllGroupActivity] */
