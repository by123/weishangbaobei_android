...
public class CleanHomeMsgActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.CleanHomeMsgActivity] */
    @Subscribe
    ...
    private void initView() {
        ...
        this.customRadioSwitchLayout1.setOnModelSelectListener(new CustomRadioSwitchLayout.OnModelSelectListener() {
            /* JADX WARNING: type inference failed for: r3v1, types: [android.content.Context, com.wx.assistants.activity.CleanHomeMsgActivity] */
            public void mode(int i) {
