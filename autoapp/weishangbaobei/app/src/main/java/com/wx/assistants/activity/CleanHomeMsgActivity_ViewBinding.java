...
public class CleanHomeMsgActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v8, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v13, types: [com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v17, types: [com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v21, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$5] */
    /* JADX WARNING: type inference failed for: r1v28, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$6] */
    /* JADX WARNING: type inference failed for: r1v35, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$7] */
    /* JADX WARNING: type inference failed for: r0v48, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanHomeMsgActivity_ViewBinding$8] */
    @UiThread
