...
public class CleanZombiePullGroupActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v8, types: [com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v12, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r1v16, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r1v20, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$5] */
    /* JADX WARNING: type inference failed for: r1v27, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$6] */
    /* JADX WARNING: type inference failed for: r0v31, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanZombiePullGroupActivity_ViewBinding$7] */
    @UiThread
