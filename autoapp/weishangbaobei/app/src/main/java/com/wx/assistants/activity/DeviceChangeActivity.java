...
public class DeviceChangeActivity extends BaseActivity {
    ...
    public Handler mHandler = new Handler() {
        /* JADX WARNING: type inference failed for: r3v5, types: [android.content.Context, com.wx.assistants.activity.DeviceChangeActivity] */
        /* JADX WARNING: type inference failed for: r3v6, types: [android.content.Context, com.wx.assistants.activity.DeviceChangeActivity] */
    ...
    public void initData() {
        ApiWrapper.getInstance().myUsersByPhone(MacAddressUtils.getMacAddress(MyApplication.mContext), new ApiWrapper.CallbackListener<ConmdBean>() {
            /* JADX WARNING: type inference failed for: r1v5, types: [android.content.Context, com.wx.assistants.activity.DeviceChangeActivity] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.DeviceChangeActivity] */
    ...
    private void WXPay() {
        ...
        ApiWrapper.getInstance().wechatPay(new WxPayRequest(MacAddressUtils.getMacAddress(MyApplication.mContext), this.payBean.getPhoneNumber().toString().trim(), MoneyUtils.changeY2F(Double.parseDouble(this.payBean.getWxPrice().toString().trim())), this.payId, this.selectBean.getUserId()), new ApiWrapper.CallbackListener<ConmdBean>() {
            /* JADX WARNING: type inference failed for: r0v4, types: [android.content.Context, com.wx.assistants.activity.DeviceChangeActivity] */
            /* JADX WARNING: type inference failed for: r1v3, types: [android.content.Context, com.wx.assistants.activity.DeviceChangeActivity] */
            public void onFinish(ConmdBean conmdBean) {
