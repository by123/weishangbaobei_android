...
public class GroupSendBatchToFriendActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity, android.content.Context] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r9v0, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity, android.content.Context] */
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity, android.content.Context] */
                    ...
                    startCheck(str, true, new BaseActivity.OnStartCheckListener() {
                        public void checkEnd() {
                            ...
                            if (GroupSendBatchToFriendActivity.this.msgType == 1 || GroupSendBatchToFriendActivity.this.msgType == 2) {
                                new ArrayList();
                                if (GroupSendBatchToFriendActivity.this.sendPicVideoCode == 0) {
                                    arrayList = GroupSendBatchToFriendActivity.this.selectImages;
                                } else {
                                    arrayList = GroupSendBatchToFriendActivity.this.selectVideos;
                                }
                                if (((String) arrayList.get(0)).endsWith(PictureFileUtils.POST_VIDEO)) {
                                    GroupSendBatchToFriendActivity.this.showLoadingDialog("正在处理视频", false);
                                    GroupSendBatchToFriendActivity.this.compressSaveVideo((List<String>) arrayList, (FileUtil.OnConvertMp4Listener) new FileUtil.OnConvertMp4Listener() {
                                ...
                                GroupSendBatchToFriendActivity.this.compressSaveImg((List<String>) arrayList, (BaseActivity.OnSaveImgListener) new BaseActivity.OnSaveImgListener() {
