...
public class GroupSendBatchToFriendActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v7, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v11, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v15, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v19, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v24, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v28, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$7, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v32, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$8] */
    /* JADX WARNING: type inference failed for: r1v37, types: [com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$9, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v42, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$10] */
    /* JADX WARNING: type inference failed for: r1v54, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendBatchToFriendActivity_ViewBinding$11] */
    @UiThread
