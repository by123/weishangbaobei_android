...
public class GroupSendCardToGroupActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v5, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToGroupActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v10, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToGroupActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v14, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToGroupActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r1v18, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToGroupActivity_ViewBinding$4] */
    @UiThread
