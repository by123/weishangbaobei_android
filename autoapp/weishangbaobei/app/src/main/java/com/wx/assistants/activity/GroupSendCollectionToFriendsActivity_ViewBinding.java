...
public class GroupSendCollectionToFriendsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCollectionToFriendsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v9, types: [com.wx.assistants.activity.GroupSendCollectionToFriendsActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v13, types: [com.wx.assistants.activity.GroupSendCollectionToFriendsActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v17, types: [com.wx.assistants.activity.GroupSendCollectionToFriendsActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v22, types: [com.wx.assistants.activity.GroupSendCollectionToFriendsActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v26, types: [com.wx.assistants.activity.GroupSendCollectionToFriendsActivity_ViewBinding$6, android.view.View$OnClickListener] */
    @UiThread
