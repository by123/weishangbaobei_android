...
public class GroupSendMiniProgramsToGroupActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendMiniProgramsToGroupActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v9, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendMiniProgramsToGroupActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v13, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendMiniProgramsToGroupActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r1v17, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendMiniProgramsToGroupActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r1v21, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendMiniProgramsToGroupActivity_ViewBinding$5] */
    @UiThread
