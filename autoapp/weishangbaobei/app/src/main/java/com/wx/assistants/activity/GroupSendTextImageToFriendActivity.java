...
public class GroupSendTextImageToFriendActivity extends BaseActivity implements BaseActivity.OnUserInfoListener {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendTextImageToFriendActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendTextImageToFriendActivity] */
