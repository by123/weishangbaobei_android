...
public class GroupSendTextImageToFriendCompanyActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v7, types: [com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v11, types: [com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v16, types: [com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v20, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$5] */
    /* JADX WARNING: type inference failed for: r1v24, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$6] */
    /* JADX WARNING: type inference failed for: r0v40, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToFriendCompanyActivity_ViewBinding$7] */
    @UiThread
