...
public class GroupSendVoiceToGroupActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v4, types: [com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v9, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v13, types: [com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v17, types: [com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v21, types: [com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v26, types: [com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v46, types: [com.wx.assistants.activity.GroupSendVoiceToGroupActivity_ViewBinding$7, android.view.View$OnClickListener] */
    @UiThread
