...
public class InvitationBindActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.InvitationBindActivity] */
    ...
    public void invitationBind(String str) {
        ...
        ApiWrapper.getInstance().invitationBind(new BindInvitationModel(str), new ApiWrapper.CallbackListener<ConmdBean>() {
            ...
            /* JADX WARNING: type inference failed for: r2v3, types: [android.content.Context, com.wx.assistants.activity.InvitationBindActivity] */
            /* JADX WARNING: type inference failed for: r2v4, types: [android.content.Context, com.wx.assistants.activity.InvitationBindActivity] */
