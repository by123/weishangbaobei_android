...
public class InvitationBindActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.InvitationBindActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v21, types: [com.wx.assistants.activity.InvitationBindActivity_ViewBinding$2, android.view.View$OnClickListener] */
    @UiThread
