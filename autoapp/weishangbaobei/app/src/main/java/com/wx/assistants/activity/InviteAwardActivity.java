        ...
        ApiWrapper.getInstance().getUser(MacAddressUtils.getMacAddress(MyApplication.mContext), new ApiWrapper.CallbackListener<ConmdBean>() {
            ...
            public void onFinish(com.wx.assistants.bean.ConmdBean r3) {
                /*
                    ...
                    if (r3 == 0) goto L_0x0075
                    com.wx.assistants.activity.InviteAwardActivity r3 = com.wx.assistants.activity.InviteAwardActivity.this     // Catch:{ Exception -> 0x0071 }
                ...
                L_0x006b:
                    com.wx.assistants.activity.InviteAwardActivity r0 = com.wx.assistants.activity.InviteAwardActivity.this     // Catch:{ Exception -> 0x0071 }
                ...
                L_0x0075:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.wx.assistants.activity.InviteAwardActivity.AnonymousClass1.onFinish(com.wx.assistants.bean.ConmdBean):void");
            }
        });
    }

    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.InviteAwardActivity] */
