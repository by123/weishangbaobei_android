...
public class InviteFriendActivity extends BaseActivity {
    ...
    public void initInviteData() {
        ...
        ApiWrapper.getInstance().getInviteData(new ApiWrapper.CallbackListener<ConmdBean>() {
            ...
            /* JADX WARNING: type inference failed for: r7v14, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
            /* JADX WARNING: type inference failed for: r0v6, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
            /* JADX WARNING: type inference failed for: r7v23, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
            /* JADX WARNING: type inference failed for: r0v15, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
            /* JADX WARNING: type inference failed for: r1v10, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
            /* JADX WARNING: type inference failed for: r3v3, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
                    ...
                    try {
                        ...
                        if (InviteFriendActivity.this.inviteUrl != null && !InviteFriendActivity.this.inviteUrl.equals("")) {
                            ...
                            new Thread(new Runnable() {
                                /* JADX WARNING: type inference failed for: r1v12, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
                                public void run() {
    ...
    class MyHandler extends Handler {
        ...
        /* JADX WARNING: type inference failed for: r6v5, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
        /* JADX WARNING: type inference failed for: r6v6, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
        public void handleMessage(Message message) {
            ...
            if (message.what == 0 && InviteFriendActivity.this.imagesList.size() == 1) {
                ...
                imageView.setOnLongClickListener(new View.OnLongClickListener() {
                    /* JADX WARNING: type inference failed for: r2v2, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity] */
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.InviteFriendActivity, android.app.Activity] */
