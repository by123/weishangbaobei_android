...
public class LabelRemarkActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v5, types: [com.wx.assistants.activity.LabelRemarkActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v10, types: [com.wx.assistants.activity.LabelRemarkActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v14, types: [com.wx.assistants.activity.LabelRemarkActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v18, types: [com.wx.assistants.activity.LabelRemarkActivity_ViewBinding$4, android.view.View$OnClickListener] */
    @UiThread
