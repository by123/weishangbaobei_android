...
public class LoginPasswordSettingActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r8v0, types: [com.wx.assistants.activity.LoginPasswordSettingActivity, android.content.Context] */
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [com.wx.assistants.activity.LoginPasswordSettingActivity, android.content.Context] */
    ...
    public void onViewClicked(View view) {
        ...
        if (id == 2131296657) {
            ...
            ApiWrapper.getInstance().loginPasswordSetting(new PasswordSettingRequest(this.numberText.getText().toString().trim(), trim2, this.verificationEt.getText().toString().trim()), new ApiWrapper.CallbackListener<ConmdBean>() {
                ...
                /* JADX WARNING: type inference failed for: r0v2, types: [com.wx.assistants.activity.LoginPasswordSettingActivity, android.content.Context] */
                ...
                /* JADX WARNING: type inference failed for: r4v9, types: [com.wx.assistants.activity.LoginPasswordSettingActivity, android.content.Context] */
                public void onFinish(ConmdBean conmdBean) {
                    if (conmdBean == null || conmdBean.getCode() != 0) {
                        ToastUtils.showToast(LoginPasswordSettingActivity.this, conmdBean.getMessage());
                        return;
