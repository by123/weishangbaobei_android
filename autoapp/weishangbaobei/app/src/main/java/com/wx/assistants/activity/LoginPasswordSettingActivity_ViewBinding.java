...
public class LoginPasswordSettingActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.LoginPasswordSettingActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.LoginPasswordSettingActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v17, types: [android.view.View$OnClickListener, com.wx.assistants.activity.LoginPasswordSettingActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r1v22, types: [android.view.View$OnClickListener, com.wx.assistants.activity.LoginPasswordSettingActivity_ViewBinding$4] */
    @UiThread
