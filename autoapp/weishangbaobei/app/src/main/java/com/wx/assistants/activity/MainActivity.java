...
public class MainActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        if (!((Boolean) SPUtils.get(MyApplication.getConText(), "version_open", true)).booleanValue()) {
            this.mBottomTabBar.init(getSupportFragmentManager()).setImgSize((float) SizeUtils.dp2px(24.0f), (float) SizeUtils.dp2px(24.0f)).setFontSize(12.0f).setTabPadding((float) SizeUtils.dp2px(8.0f), (float) SizeUtils.dp2px(3.0f), (float) SizeUtils.dp2px(6.0f)).setChangeColor(getResources().getColor(R.color.main_color), getResources().getColor(2131099736))
                    .addTabItem("首页", 2131231400, 2131231399, TabHomeFragment2.class).addTabItem("收益", 2131231406, 2131231405, InComeFragment2.class).addTabItem("个人中心", 2131231404, 2131231403, MyFragment.class).isShowDivider(true).setOnTabChangeListener(new BottomTabBar.OnTabChangeListener() {
                            ...
                            public void onSuccess(List<MQMessage> list) {
                                ...
                                if (list != null && list.size() > 0) {
                                    DialogUIUtils.dialogDefault(MainActivity.this, "客服提醒", "您有" + list.size() + "条客服消息未查看，是否查看？", "取消", "查看", (View.OnClickListener) null, new View.OnClickListener() {
                                        /* JADX WARNING: type inference failed for: r0v2, types: [com.wx.assistants.activity.MainActivity, android.content.Context] */
