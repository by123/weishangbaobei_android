...
public class MemberCenterPassiveCardActivity extends BaseActivity implements MemberPassiveCardAdapter.OnClick, BaseActivity.OnUserInfoListener {
    ...
    public Handler mHandler = new Handler() {
        /* JADX WARNING: type inference failed for: r3v5, types: [android.content.Context, com.wx.assistants.activity.MemberCenterPassiveCardActivity] */
        /* JADX WARNING: type inference failed for: r3v6, types: [android.content.Context, com.wx.assistants.activity.MemberCenterPassiveCardActivity] */
    ...
    public void initData() {
        ApiWrapper.getInstance().getFee(new ApiWrapper.CallbackListener<ConmdBean>() {
            /* JADX WARNING: type inference failed for: r0v3, types: [android.content.Context, com.wx.assistants.activity.MemberCenterPassiveCardActivity] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.MemberCenterPassiveCardActivity] */
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [android.content.Context, com.wx.assistants.activity.MemberCenterPassiveCardActivity] */
    private void ZFBPay() {
    ...
    private void WXPay() {
        ...
        ApiWrapper.getInstance().wechatPay(new WxPayRequest(macAddress, trim, changeY2F, str, this.id + ""), new ApiWrapper.CallbackListener<ConmdBean>() {
            ...
            /* JADX WARNING: type inference failed for: r1v4, types: [android.content.Context, com.wx.assistants.activity.MemberCenterPassiveCardActivity] */
            public void onFinish(ConmdBean conmdBean) {
