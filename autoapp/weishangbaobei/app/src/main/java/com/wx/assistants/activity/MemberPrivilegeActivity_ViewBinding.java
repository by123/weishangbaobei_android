...
public class MemberPrivilegeActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v6, types: [android.view.View$OnClickListener, com.wx.assistants.activity.MemberPrivilegeActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v12, types: [com.wx.assistants.activity.MemberPrivilegeActivity_ViewBinding$2, android.view.View$OnClickListener] */
    @UiThread
