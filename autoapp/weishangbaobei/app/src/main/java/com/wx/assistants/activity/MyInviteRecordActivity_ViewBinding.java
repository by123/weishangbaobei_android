...
public class MyInviteRecordActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.MyInviteRecordActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v13, types: [com.wx.assistants.activity.MyInviteRecordActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v26, types: [com.wx.assistants.activity.MyInviteRecordActivity_ViewBinding$3, android.view.View$OnClickListener] */
    @UiThread
