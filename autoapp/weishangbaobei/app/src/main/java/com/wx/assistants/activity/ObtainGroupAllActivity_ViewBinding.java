...
public class ObtainGroupAllActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.ObtainGroupAllActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v8, types: [com.wx.assistants.activity.ObtainGroupAllActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v12, types: [com.wx.assistants.activity.ObtainGroupAllActivity_ViewBinding$3, android.view.View$OnClickListener] */
    @UiThread
