...
public class ObtainSingleTagActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.ObtainSingleTagActivity] */
    @Subscribe
                ...
                if (this.labelList != null && !this.labels.isEmpty()) {
                    ...
                    if (this.labList != null && this.labList.size() > 0) {
                        ...
                        this.myListAdapter.setOnClickTagNameListener(new MySingleListAdapter.OnClickTagNameListener() {
                            /* JADX WARNING: type inference failed for: r0v4, types: [android.content.Context, com.wx.assistants.activity.ObtainSingleTagActivity] */
