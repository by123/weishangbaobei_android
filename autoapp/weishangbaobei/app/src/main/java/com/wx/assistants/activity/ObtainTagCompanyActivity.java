...
public class ObtainTagCompanyActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.ObtainTagCompanyActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.content.Context, com.wx.assistants.activity.ObtainTagCompanyActivity] */
