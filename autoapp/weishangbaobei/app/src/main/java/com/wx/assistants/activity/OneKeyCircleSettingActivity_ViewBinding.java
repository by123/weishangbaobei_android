...
public class OneKeyCircleSettingActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v8, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v17, types: [com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v24, types: [com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v31, types: [com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v38, types: [com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v43, types: [com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$7, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v48, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyCircleSettingActivity_ViewBinding$8] */
    @UiThread
