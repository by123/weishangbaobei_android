...
public class OneKeyCopyWXHActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.OneKeyCopyWXHActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [android.content.Context, com.wx.assistants.activity.OneKeyCopyWXHActivity] */
    ...
    public void onEventMainThread(WxTagEvent wxTagEvent) {
        ...
        if (selectedTagList == null || selectedTagList.size() <= 0) {
            ...
            for (int i = 0; i < selectedTagList.size(); i++) {
                this.tagList.add(selectedTagList.get(i));
