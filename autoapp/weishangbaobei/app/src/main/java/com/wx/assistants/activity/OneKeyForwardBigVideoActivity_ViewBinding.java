...
public class OneKeyForwardBigVideoActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v11, types: [com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v15, types: [com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v19, types: [com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v24, types: [com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v28, types: [com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$7, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v32, types: [com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$8, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v41, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardBigVideoActivity_ViewBinding$9] */
    @UiThread
