...
public class OneKeyForwardMaterialActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardMaterialActivity_ViewBinding$1] */
    @UiThread
