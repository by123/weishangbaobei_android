...
import com.wx.assistants.adapter.FragmentVoiceAdapter;
...
public class OneKeyForwardVoiceActivity extends BaseActivity {
    private FragmentVoiceAdapter adapter;
    @BindView(2131297049)
    ...
    static {
        StubApp.interface11(6752);
    }

    /* access modifiers changed from: protected */
    public native void onCreate(Bundle bundle);

    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.OneKeyForwardVoiceActivity] */
    @Subscribe
    ...
    public void initView() {
        ...
        this.navRightText.setText("视频介绍");
        ArrayList arrayList = new ArrayList();
        arrayList.add("我的语音");
        arrayList.add("微信语音");
        arrayList.add("我的收藏");
        this.adapter = new FragmentVoiceAdapter(getSupportFragmentManager(), arrayList);
        this.viewPager.setAdapter(this.adapter);
        this.tabLayout.setOnClickTabListener(new OnClickTabListener() {
            public void onClickTab(int i) {
                OneKeyForwardVoiceActivity.this.viewPager.setCurrentItem(i);
                if (i == 1) {
                    OneKeyForwardVoiceActivity.this.tabLayout.setNumberBadge(i, 0);
                } else {
                    OneKeyForwardVoiceActivity.this.tabLayout.setNumberBadge(i, 1);
                }
            }
        });
