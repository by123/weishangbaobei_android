...
public class OneKeyForwardVoiceActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardVoiceActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v9, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardVoiceActivity_ViewBinding$2] */
    @UiThread
