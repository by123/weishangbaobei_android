...
public class OneKeyImageVoiceActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
    ...
    public void execute(final boolean z) {
        if (this.selectVoices != null && this.selectVoices.size() > 0 && this.selectVoices.get(0).endsWith(".mp3")) {
            ...
            new Thread(new Runnable() {
                /* JADX WARNING: type inference failed for: r2v1, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
                public void run() {
                    ...
                    convert.setConvertListener(new ConvertListener() {
                        ...
                        public void onFinish(final String str) {
                            OneKeyImageVoiceActivity.this.runOnUiThread(new Runnable() {
                                /* JADX WARNING: type inference failed for: r0v5, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
                                /* JADX WARNING: type inference failed for: r1v12, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
                                /* JADX WARNING: type inference failed for: r0v14, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
                                /* JADX WARNING: type inference failed for: r0v20, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
                                /* JADX WARNING: type inference failed for: r0v29, types: [android.content.Context, com.wx.assistants.activity.OneKeyImageVoiceActivity] */
                                public void run() {
                                    try {
                                        if (str != null && !"".equals(str)) {
