...
public class PassiveActivity extends BaseActivity {
    ...
    public void initData() {
        ApiWrapper.getInstance().getMyCardList(1, SocializeConstants.CANCLE_RESULTCODE, new ApiWrapper.CallbackListener<ConmdListBean>() {
            ...
            /* JADX WARNING: type inference failed for: r2v2, types: [android.content.Context, com.wx.assistants.activity.PassiveActivity] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.PassiveActivity] */
