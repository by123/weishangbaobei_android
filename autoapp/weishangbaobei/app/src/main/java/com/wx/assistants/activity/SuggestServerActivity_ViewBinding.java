...
public class SuggestServerActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.activity.SuggestServerActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.SuggestServerActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v11, types: [com.wx.assistants.activity.SuggestServerActivity_ViewBinding$3, android.view.View$OnClickListener] */
    @UiThread
