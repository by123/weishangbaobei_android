...
public class WechatSportsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v6, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v10, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v14, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r1v20, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r1v25, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$5] */
    /* JADX WARNING: type inference failed for: r1v30, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$6] */
    /* JADX WARNING: type inference failed for: r1v34, types: [android.view.View$OnClickListener, com.wx.assistants.activity.WechatSportsActivity_ViewBinding$7] */
    @UiThread
