...
public class WithdrawalsRecordActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, com.wx.assistants.activity.WithdrawalsRecordActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [android.content.Context, com.wx.assistants.activity.WithdrawalsRecordActivity] */
