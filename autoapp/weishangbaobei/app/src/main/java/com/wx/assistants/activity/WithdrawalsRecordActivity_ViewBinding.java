...
public class WithdrawalsRecordActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [com.wx.assistants.activity.WithdrawalsRecordActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r1v10, types: [com.wx.assistants.activity.WithdrawalsRecordActivity_ViewBinding$2, android.view.View$OnClickListener] */
    @UiThread
