...
public class TabHomeFragment extends Fragment {
    ...
    public void initViewData() {
        ...
        ArrayList<HomeItemBean> arrayList = this.homeRenMaiItemBeans;
        HomeItemBean homeItemBean = r9;
        HomeItemBean homeItemBean2 = new HomeItemBean(AutoAddContactCameraActivity.class, 0, 2131558507, "拍照加人", "", false);
    ...
    private class ImgAdapter extends PagerAdapter {
        ...
        public void destroyItem(ViewGroup viewGroup, int i, Object obj) {
            int size = i % TabHomeFragment.this.list_imgs.size();
