...
public class AutoAddSearchUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
    ...
    public void inputSayContent() {
        ...
        L_0x0065:
            ...
            com.wx.assistants.service_utils.AutoAddSearchUtils$3 r3 = new com.wx.assistants.service_utils.AutoAddSearchUtils$3     // Catch:{ Exception -> 0x00bc }
        ...
        L_0x008b:
            ...
            java.lang.String r2 = "自动搜索加人\n已检索 "
            r1.append(r2)     // Catch:{ Exception -> 0x00bc }
            int r2 = r4.recordSearchNum     // Catch:{ Exception -> 0x00bc }
            r1.append(r2)     // Catch:{ Exception -> 0x00bc }
            java.lang.String r2 = " 人，待检索 "
            r1.append(r2)     // Catch:{ Exception -> 0x00bc }
            java.util.List<com.wx.assistants.bean.PassiveCardBean> r2 = r4.fans     // Catch:{ Exception -> 0x00bc }
        ...
        L_0x00c0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wx.assistants.service_utils.AutoAddSearchUtils.inputSayContent():void");
    }
            ...
            public void find(int i) {
                ...
                new PerformClickUtils2().checkNodeStringsHasSomeOne(AutoAddSearchUtils.this.autoService, "查找手机/QQ号", "查找微信号", 600, CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION, 10, new PerformClickUtils2.OnCheckListener() {
                                ...
                                new PerformClickUtils2().checkNodeIdNameHasSomeOne3(AutoAddSearchUtils.this.autoService, BaseServiceUtils.dialog_ok_id, "添加到通讯录", "发消息", BaseServiceUtils.executeSpeedSetting + CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION, 100, 200, new PerformClickUtils2.OnCheckListener() {
                                    ...
                                    public void find(int r3) {
                                        /*
                                            ...
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6$1 r3 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.AnonymousClass1.this     // Catch:{ Exception -> 0x00a5 }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6 r3 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.this     // Catch:{ Exception -> 0x00a5 }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils r3 = com.wx.assistants.service_utils.AutoAddSearchUtils.this     // Catch:{ Exception -> 0x00a5 }
                                        ...
                                        L_0x002e:
                                            ...
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6$1 r0 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.AnonymousClass1.this     // Catch:{ Exception -> 0x004c }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6 r0 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.this     // Catch:{ Exception -> 0x004c }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils r0 = com.wx.assistants.service_utils.AutoAddSearchUtils.this     // Catch:{ Exception -> 0x004c }
                                        ...
                                        L_0x004c:
                                            ...
                                            java.lang.String r1 = "自动搜索加人\n已检索 "
                                            r0.append(r1)     // Catch:{ Exception -> 0x00a5 }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6$1 r1 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.AnonymousClass1.this     // Catch:{ Exception -> 0x00a5 }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6 r1 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.this     // Catch:{ Exception -> 0x00a5 }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils r1 = com.wx.assistants.service_utils.AutoAddSearchUtils.this     // Catch:{ Exception -> 0x00a5 }
                                            ...
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6 r1 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.this     // Catch:{ Exception -> 0x00a5 }
                                            com.wx.assistants.service_utils.AutoAddSearchUtils r1 = com.wx.assistants.service_utils.AutoAddSearchUtils.this     // Catch:{ Exception -> 0x00a5 }
                                            java.util.List r1 = r1.fans     // Catch:{ Exception -> 0x00a5 }
                                            ...
                                            com.wx.assistants.service.AutoService r3 = r3.autoService     // Catch:{ Exception -> 0x00a5 }
                                            r0 = 30
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6$1$1$1 r1 = new com.wx.assistants.service_utils.AutoAddSearchUtils$6$1$1$1     // Catch:{ Exception -> 0x00a5 }
                                        ...
                                        L_0x00a5:
                                            ...
                                            goto L_0x00b3
                                        L_0x00aa:
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6$1 r3 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.AnonymousClass1.this
                                            com.wx.assistants.service_utils.AutoAddSearchUtils$6 r3 = com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.this
                                            com.wx.assistants.service_utils.AutoAddSearchUtils r3 = com.wx.assistants.service_utils.AutoAddSearchUtils.this
                                            r3.initFirstContactInfo()
                                        L_0x00b3:
                                            return
                                        */
                                        throw new UnsupportedOperationException("Method not decompiled: com.wx.assistants.service_utils.AutoAddSearchUtils.AnonymousClass6.AnonymousClass1.AnonymousClass1.find(int):void");
                                    }
                                });
                            }
                        }
                    ...
                    public void nuFind() {
                        ...
                        int unused2 = AutoAddSearchUtils.this.recordSearchNum = AutoAddSearchUtils.this.recordSearchNum + 1;
                        AutoAddSearchUtils.this.fans.remove(0);
                        PerformClickUtils.executedBackHome(AutoAddSearchUtils.this.autoService, 30, new PerformClickUtils.OnBackMainPageListener() {
                            public void find() {
                                AutoAddSearchUtils.this.executeMain();
