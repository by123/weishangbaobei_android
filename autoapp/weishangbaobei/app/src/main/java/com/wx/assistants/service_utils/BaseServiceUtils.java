...
public class BaseServiceUtils {
    ...
    public boolean isWXGroup() {
        ...
        try {
            if (!(this.autoService == null || (rootInActiveWindow = this.autoService.getRootInActiveWindow()) == null)) {
                ...
                if (findAccessibilityNodeInfosByViewId == null || findAccessibilityNodeInfosByViewId.size() <= 0 || findAccessibilityNodeInfosByViewId2 == null || findAccessibilityNodeInfosByViewId2.size() <= 0 || findAccessibilityNodeInfosByViewId2.get(0).getText().toString() == null || !findAccessibilityNodeInfosByViewId2.get(0).getText().toString().contains("(")) {
                    return false;
                }
                return true;
            }
    ...
    public void saveFriendInfo(String str) {
        ...
        try {
            ...
            if (textByNodeId2 == null || "".equals(textByNodeId2)) {
                ...
                str2 = textByNodeId2.contains(":") ? textByNodeId2.split(":")[1].trim() : "";
            }
            SQLiteUtils.getInstance().addFriend(new RecoverFriendBean(str2, str, DateUtils.timeToString(System.currentTimeMillis()), false));
        } catch (Exception unused) {
        }
    }

    /* JADX WARNING: Removed duplicated region for block: B:30:0x0077 A[Catch:{ Exception -> 0x00a9 }] */
    /* JADX WARNING: Removed duplicated region for block: B:34:0x008f A[Catch:{ Exception -> 0x00a9 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void saveCopyFriendInfo(java.lang.String r10) {
        /*
            r9 = this;
            com.wx.assistants.service.AutoService r0 = r9.autoService     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r1 = wx_nick_name     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r0 = com.wx.assistants.utils.PerformClickUtils.getTextByNodeId(r0, r1)     // Catch:{ Exception -> 0x00a9 }
            com.wx.assistants.service.AutoService r1 = r9.autoService     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r2 = wx_number     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r1 = com.wx.assistants.utils.PerformClickUtils.getTextByNodeId(r1, r2)     // Catch:{ Exception -> 0x00a9 }
            r2 = 1
            if (r0 == 0) goto L_0x003d
            java.lang.String r3 = ""
            boolean r3 = r3.equals(r0)     // Catch:{ Exception -> 0x00a9 }
            if (r3 != 0) goto L_0x003d
            java.lang.String r3 = ":"
            boolean r3 = r0.contains(r3)     // Catch:{ Exception -> 0x00a9 }
            if (r3 == 0) goto L_0x003f
            java.lang.String r3 = ":"
            java.lang.String[] r0 = r0.split(r3)     // Catch:{ Exception -> 0x00a9 }
            r0 = r0[r2]     // Catch:{ Exception -> 0x00a9 }
            if (r0 == 0) goto L_0x003a
            java.lang.String r3 = ""
            boolean r3 = r3.equals(r0)     // Catch:{ Exception -> 0x00a9 }
            if (r3 != 0) goto L_0x003a
            java.lang.String r0 = r0.trim()     // Catch:{ Exception -> 0x00a9 }
            goto L_0x003f
        L_0x003a:
            java.lang.String r0 = ""
            goto L_0x003f
        ...
        L_0x003f:
            ...
            com.wx.assistants.service.AutoService r0 = r9.autoService     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r3 = wx_nick_remark_name     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r0 = com.wx.assistants.utils.PerformClickUtils.getTextFirstByNodeId(r0, r3)     // Catch:{ Exception -> 0x00a9 }
        ...
        L_0x005e:
            ...
            java.lang.String r0 = ""
            boolean r0 = r0.equals(r10)     // Catch:{ Exception -> 0x00a9 }
        ...
        L_0x006d:
            ...
            java.lang.String r0 = ":"
            boolean r0 = r1.contains(r0)     // Catch:{ Exception -> 0x00a9 }
            if (r0 == 0) goto L_0x008c
            java.lang.String r0 = ":"
            java.lang.String[] r0 = r1.split(r0)     // Catch:{ Exception -> 0x00a9 }
            r0 = r0[r2]     // Catch:{ Exception -> 0x00a9 }
            java.lang.String r0 = r0.trim()     // Catch:{ Exception -> 0x00a9 }
            goto L_0x0091
        L_0x008c:
        ...
        L_0x0091:
            ...
            java.lang.String r7 = com.wx.assistants.utils.DateUtils.timeToString(r0)     // Catch:{ Exception -> 0x00a9 }
            com.wx.assistants.utils.SQLiteUtils r0 = com.wx.assistants.utils.SQLiteUtils.getInstance()     // Catch:{ Exception -> 0x00a9 }
            com.wx.assistants.Enity.CopyFriendBean r1 = new com.wx.assistants.Enity.CopyFriendBean     // Catch:{ Exception -> 0x00a9 }
            r8 = 0
            r3 = r1
            r6 = r10
            r3.<init>(r4, r5, r6, r7, r8)     // Catch:{ Exception -> 0x00a9 }
            r0.addCopyFriend(r1)     // Catch:{ Exception -> 0x00a9 }
        L_0x00a9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wx.assistants.service_utils.BaseServiceUtils.saveCopyFriendInfo(java.lang.String):void");
    }
