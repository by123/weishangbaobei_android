                                    ...
                                    if (rootInActiveWindow != null && MyApplication.enforceable) {
                                        ...
                                        if ((findNodeIsExistByText || findNodeIsExistByText2) && MyApplication.enforceable) {
                                            ...
                                            try {
                                                ...
                                                while (true) {
                                                    if (access$200 >= findAccessibilityNodeInfosByViewId.size()) {
                                                        break;
                                                    } else if (findAccessibilityNodeInfosByViewId.get(access$200).toString().contains(CleanFriendsNickNameUtils.this.inputText)) {
                                                        int unused = CleanFriendsNickNameUtils.this.jumpDeleteNum = access$200;
                                                        break;
                                                    } else {
                                                        access$200++;
                                                    }
