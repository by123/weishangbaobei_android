            ...
            new PerformClickUtils2().checkFavListNodeId(this.autoService, collection_list_id, this.isFirstFav ? SocializeConstants.CANCLE_RESULTCODE : executeSpeed + executeSpeedSetting, 100, 600, new PerformClickUtils2.OnCheckListener() {
                ...
                public void find(int r8) {
                    /*
                        ...
                        com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils r8 = com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils.this
                    ...
                    L_0x00a5:
                        ...
                        com.wx.assistants.utils.LogUtils.log(r2)
                        com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils r2 = com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils.this     // Catch:{ Exception -> 0x00d7 }
                        com.wx.assistants.service.AutoService r2 = r2.autoService     // Catch:{ Exception -> 0x00d7 }
                        java.lang.String r3 = com.wx.assistants.service_utils.BaseServiceUtils.collection_list_id     // Catch:{ Exception -> 0x00d7 }
                        java.util.List r2 = com.wx.assistants.utils.PerformClickUtils.findViewIdList((android.accessibilityservice.AccessibilityService) r2, (java.lang.String) r3)     // Catch:{ Exception -> 0x00d7 }
                        if (r2 == 0) goto L_0x00d7
                        int r3 = r2.size()     // Catch:{ Exception -> 0x00d7 }
                        if (r3 <= 0) goto L_0x00d7
                        java.lang.Object r2 = r2.get(r1)     // Catch:{ Exception -> 0x00d7 }
                        android.view.accessibility.AccessibilityNodeInfo r2 = (android.view.accessibility.AccessibilityNodeInfo) r2     // Catch:{ Exception -> 0x00d7 }
                        int r2 = r2.getChildCount()     // Catch:{ Exception -> 0x00d7 }
                        if (r2 <= r0) goto L_0x00d7
                        java.lang.Object r8 = r8.get(r1)     // Catch:{ Exception -> 0x00d7 }
                        android.view.accessibility.AccessibilityNodeInfo r8 = (android.view.accessibility.AccessibilityNodeInfo) r8     // Catch:{ Exception -> 0x00d7 }
                        android.view.accessibility.AccessibilityNodeInfo r8 = r8.getChild(r0)     // Catch:{ Exception -> 0x00d7 }
                        com.wx.assistants.utils.PerformClickUtils.performClick(r8)     // Catch:{ Exception -> 0x00d7 }
                    L_0x00d7:
                        ...
                        r4 = 50
                        r5 = 100
                        com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils$11$1 r6 = new com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils$11$1
                        r6.<init>()
                        r0.checkNodeId(r1, r2, r3, r4, r5, r6)
                    L_0x00f5:
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.wx.assistants.service_utils.GroupSendCollectionToGroupUtils.AnonymousClass11.find(int):void");
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
