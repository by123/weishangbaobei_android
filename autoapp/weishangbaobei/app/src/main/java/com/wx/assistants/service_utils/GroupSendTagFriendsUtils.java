...
public class GroupSendTagFriendsUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
    ...
    public void initAlbumPreviewUI() {
        try {
            if ((!"7.0.15".equals(wxVersionName) || wxVersionCode != 1660) && wxVersionCode <= 1660) {
                new PerformClickUtils2().checkNodeId(this.autoService, video_first_id, executeSpeedSetting + executeSpeed, 100, 600, new PerformClickUtils2.OnCheckListener() {
                    public void nuFind() {
                    }
                ...
                public void find(int i) {
                    ...
                    new PerformClickUtils2().checkString(GroupSendTagFriendsUtils.this.autoService, "发送", 100, 50, 100, new PerformClickUtils2.OnCheckListener() {
                        ...
                        public void find(int i) {
                            ...
                            new PerformClickUtils2().checkString(GroupSendTagFriendsUtils.this.autoService, "再发一条", BaseServiceUtils.executeSpeedSetting + BaseServiceUtils.executeSpeed, 300, 400, new PerformClickUtils2.OnCheckListener() {
                                public void find(int i) {
                                    LogUtils.log("WS_BABY.MassSendHistoryUI_22");
                                    PerformClickUtils.findTextAndClick(GroupSendTagFriendsUtils.this.autoService, "再发一条");
        ...
        new PerformClickUtils2().checkNodeIds(this.autoService, new_group_send_big_id, new_group_send_id, executeSpeed + executeSpeedSetting, 100, 600, new PerformClickUtils2.OnCheckListener() {
            ...
            public void find(int i) {
                if (MyApplication.enforceable) {
                    ...
                    if (GroupSendTagFriendsUtils.this.lastOperationNum != 0) {
                        i2 = GroupSendTagFriendsUtils.this.lastOperationNum;
                    }
                    SPUtils.put(conText, "batch_text_img_num_part", Integer.valueOf(i2));
                    switch (i) {
                        case 0:
    ...
    public void selectContacts() {
        try {
            ...
            new PerformClickUtils2().checkNodeAllIds(this.autoService, list_select_name_id, list_select_checkbox, executeSpeedSetting + executeSpeed, 100, 600, new PerformClickUtils2.OnCheckListener() {
                public void nuFind() {
                }
