    ...
    public void initExMore() {
        ...
        new PerformClickUtils2().check(this.autoService, right_more_id, 100, 100, 10, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
            public void find(int i) {
                ...
                new PerformClickUtils2().checkNodeStringsHasSomeOne(LabelRemarkAllUtils.this.autoService, "设置备注和标签", "设置备注及标签", (BaseServiceUtils.executeSpeedSetting / 8) + BaseServiceUtils.executeSpeed, 100, 10, new PerformClickUtils2.OnCheckListener() {
                    public void find(int i) {
                    ...
                    if (findViewIdList2 != null && findViewIdList2.size() > 0) {
                        ...
                        if (charSequence.contains("，")) {
                            ...
                            if (charSequence.contains("，")) {
                                ...
                                boolean z = false;
                                while (i2 < split.length && !(z = LabelRemarkAllUtils.this.nameLists.contains(split[i2]))) {
                                    i2++;
                                }
                                if (z) {
                                    PerformClickUtils.executedRemarkBackHome(LabelRemarkAllUtils.this.autoService, 30, new PerformClickUtils.OnBackMainPageListener2() {
                    ...
                    if (LabelRemarkAllUtils.this.startIndex < findViewIdList.size() && MyApplication.enforceable) {
                        ...
                        if (accessibilityNodeInfo != null) {
                            if (accessibilityNodeInfo.getText() != null) {
                                LabelRemarkAllUtils labelRemarkAllUtils = LabelRemarkAllUtils.this;
                                String unused = labelRemarkAllUtils.nowName = accessibilityNodeInfo.getText() + "";
                            ...
                            if (LabelRemarkAllUtils.this.isScrollBottom && LabelRemarkAllUtils.this.beforeLists.contains(LabelRemarkAllUtils.this.nowName)) {
                                ...
                                BaseServiceUtils.updateBottomText(myWindowManager, "正在智能分组,已执行 " + LabelRemarkAllUtils.this.excFriendsNum + " 人");
