...
public class LikeCommentFriendsUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
    ...
    public void initContactInfoUI() {
        ...
        this.excFriendsNum++;
        statisticsData();
        new PerformClickUtils2().checkString(this.autoService, "发消息", executeSpeedSetting + executeSpeed, 50, 50, new PerformClickUtils2.OnCheckListener() {
    ...
    public void initSingleChatInfo() {
        try {
            if (MyApplication.enforceable) {
                new PerformClickUtils2().check(this.autoService, single_contact_nick_name_id, executeSpeedSetting + executeSpeed, 100, 20, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
                    public void nuFind() {
                    }
    ...
    public void executeMain() {
        try {
            ...
            new PerformClickUtils2().checkNodeAllIds(this.autoService, grout_friend_list_id, list_item_name_id, executeSpeedSetting + executeSpeed, 100, 600, new PerformClickUtils2.OnCheckListener() {
                public void nuFind() {
                }
