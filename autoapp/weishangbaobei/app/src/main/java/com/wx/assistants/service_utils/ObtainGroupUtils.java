                        ...
                        public void find(int i) {
                            ...
                            if (findViewIdList == null || findViewIdList.size() <= 0 || !MyApplication.enforceable) {
                                ...
                                if (accessibilityNodeInfo != null && MyApplication.enforceable) {
                                    ...
                                    String unused5 = ObtainGroupUtils.this.wxName = str2;
                                    String unused6 = ObtainGroupUtils.this.wxNumber = str;
                                    GroupBean groupBean2 = new GroupBean();
                                    groupBean2.setWxName(str2);
                                    groupBean2.setWxNum(str);
                                    SQLiteUtils.getInstance().addGroupBean(groupBean2);
                                    SPUtils.put(ObtainGroupUtils.this.autoService, "wx_user", str2 + "#" + str);
                                }
                            }
