                        ...
                        while (true) {
                            if (i >= findAccessibilityNodeInfosByViewId2.size()) {
                                ...
                                if (accessibilityNodeInfo6 != null && MyApplication.enforceable) {
                                    if ((wxVersionCode > 1620 || (wxVersionCode == 1620 && "7.0.13".equals(wxVersionName))) && (accessibilityNodeInfo6 = accessibilityNodeInfo6.getParent()) == null) {
                                        accessibilityNodeInfo6 = findAccessibilityNodeInfosByViewId2.get(i);
                                    }
                                    List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId3 = accessibilityNodeInfo6.findAccessibilityNodeInfosByViewId(circle_list_layout_nickname_id);
                                    List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId4 = accessibilityNodeInfo6.findAccessibilityNodeInfosByViewId(circle_list_layout_hide_text_id);
                                    List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId5 = accessibilityNodeInfo6.findAccessibilityNodeInfosByViewId(circle_list_layout_text_id);
                                    List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId6 = accessibilityNodeInfo6.findAccessibilityNodeInfosByViewId(circle_list_layout_img_id);
                                    List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId7 = accessibilityNodeInfo6.findAccessibilityNodeInfosByViewId(circle_list_layout_video_id);
                                    ...
                                    if (recordTags == null || recordTags.contains(sb2.toString()) || !MyApplication.enforceable) {
                                        ...
                                        List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId8 = accessibilityNodeInfo6.findAccessibilityNodeInfosByViewId(expand_more_id);
                                        if (findAccessibilityNodeInfosByViewId8 == null || findAccessibilityNodeInfosByViewId8.size() <= 0 || !MyApplication.enforceable) {
                                            ...
                                            AccessibilityNodeInfo accessibilityNodeInfo7 = findAccessibilityNodeInfosByViewId8.get(0);
                                            if (accessibilityNodeInfo7 != null && MyApplication.enforceable) {
