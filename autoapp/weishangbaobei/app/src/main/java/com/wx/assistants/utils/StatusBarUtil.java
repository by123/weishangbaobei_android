...
public class StatusBarUtil {
    ...
    public static boolean isMIUI() {
        ...
        try {
            ...
            if (properties.getProperty(KEY_MIUI_VERSION_CODE, (String) null) == null && properties.getProperty(KEY_MIUI_VERSION_NAME, (String) null) == null && properties.getProperty(KEY_MIUI_INTERNAL_STORAGE, (String) null) == null) {
                return false;
            }
            return true;
        } catch (IOException e) {
