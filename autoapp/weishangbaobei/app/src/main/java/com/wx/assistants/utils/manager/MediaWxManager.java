    ...
    private static void initSensorListener(Context context) {
        ...
        mSensorManager.registerListener(new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                try {
                    if (sensorEvent.values[0] >= MediaWxManager.sensor.getMaximumRange()) {
                        MediaWxManager.changeAdapterType(true);
                    } else {
                        MediaWxManager.changeAdapterType(false);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
