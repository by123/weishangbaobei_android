                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused3 = FriendSendModeLayout2.this.startIndexAll = 1;
                        }
                        FriendSendModeLayout2.this.start_pull.setText("从第" + FriendSendModeLayout2.this.startIndexAll + "个好友开始拉人进群");
                        FontUtils.changeFontColor(FriendSendModeLayout2.this.mContext, FriendSendModeLayout2.this.start_pull);
                        String unused4 = FriendSendModeLayout2.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyAllLabel, "");
                        ...
                        String unused5 = FriendSendModeLayout2.this.friendsTags = FriendSendModeLayout2.this.allLabel;
                        if (FriendSendModeLayout2.this.listener != null) {
                            int unused6 = FriendSendModeLayout2.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused7 = FriendSendModeLayout2.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyPart, 1)).intValue();
                        } catch (Exception unused8) {
                            int unused9 = FriendSendModeLayout2.this.startIndexPart = 1;
                        }
                        FriendSendModeLayout2.this.start_pull.setText("从第" + FriendSendModeLayout2.this.startIndexPart + "个好友开始拉人进群");
                        FontUtils.changeFontColor(FriendSendModeLayout2.this.mContext, FriendSendModeLayout2.this.start_pull);
                        String unused10 = FriendSendModeLayout2.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyPartLabel, "");
                        ...
                        String unused11 = FriendSendModeLayout2.this.friendsTags = FriendSendModeLayout2.this.partLabel;
                        if (FriendSendModeLayout2.this.listener != null) {
                            int unused12 = FriendSendModeLayout2.this.sendTypeMode = 1;
                            FriendSendModeLayout2.this.listener.sendType(FriendSendModeLayout2.this.sendTypeMode);
                            FriendSendModeLayout2.this.listener.sendStartIndex(FriendSendModeLayout2.this.startIndexPart);
                        }
                        String unused13 = FriendSendModeLayout2.this.partLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyPartLabelMember, "");
                    ...
                    case 2131296498:
                        ...
                        FriendSendModeLayout2.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused14 = FriendSendModeLayout2.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyShield, 1)).intValue();
                        } catch (Exception unused15) {
                            int unused16 = FriendSendModeLayout2.this.startIndexShield = 1;
                        }
                        FriendSendModeLayout2.this.start_pull.setText("从第" + FriendSendModeLayout2.this.startIndexShield + "个好友开始拉人进群");
                        FontUtils.changeFontColor(FriendSendModeLayout2.this.mContext, FriendSendModeLayout2.this.start_pull);
                        String unused17 = FriendSendModeLayout2.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyShieldLabel, "");
                        ...
                        String unused18 = FriendSendModeLayout2.this.friendsTags = FriendSendModeLayout2.this.shieldLabel;
                        if (FriendSendModeLayout2.this.listener != null) {
                            int unused19 = FriendSendModeLayout2.this.sendTypeMode = 2;
                            FriendSendModeLayout2.this.listener.sendStartIndex(FriendSendModeLayout2.this.startIndexShield);
                            FriendSendModeLayout2.this.listener.sendType(FriendSendModeLayout2.this.sendTypeMode);
                        }
                        String unused20 = FriendSendModeLayout2.this.shieldLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout2.this.keyShieldLabelMember, "");
