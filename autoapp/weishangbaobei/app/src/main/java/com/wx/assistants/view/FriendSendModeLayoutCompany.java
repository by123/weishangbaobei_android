                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused3 = FriendSendModeLayoutCompany.this.startIndexAll = 1;
                        }
                        TextView access$000 = FriendSendModeLayoutCompany.this.start_pull;
                        access$000.setText("从第" + FriendSendModeLayoutCompany.this.startIndexAll + "个开始");
                        FontUtils.changeFontColor(FriendSendModeLayoutCompany.this.mContext, FriendSendModeLayoutCompany.this.start_pull);
                        String unused4 = FriendSendModeLayoutCompany.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutCompany.this.keyAllLabel, "");
                        ...
                        String unused5 = FriendSendModeLayoutCompany.this.friendsTags = FriendSendModeLayoutCompany.this.allLabel;
                        if (FriendSendModeLayoutCompany.this.listener != null) {
                            int unused6 = FriendSendModeLayoutCompany.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused7 = FriendSendModeLayoutCompany.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutCompany.this.keyPart, 1)).intValue();
                        } catch (Exception unused8) {
                            int unused9 = FriendSendModeLayoutCompany.this.startIndexPart = 1;
                        }
                        TextView access$0002 = FriendSendModeLayoutCompany.this.start_pull;
                        access$0002.setText("从第" + FriendSendModeLayoutCompany.this.startIndexPart + "个开始");
                        FontUtils.changeFontColor(FriendSendModeLayoutCompany.this.mContext, FriendSendModeLayoutCompany.this.start_pull);
                        String unused10 = FriendSendModeLayoutCompany.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutCompany.this.keyPartLabel, "");
                        ...
                        String unused11 = FriendSendModeLayoutCompany.this.friendsTags = FriendSendModeLayoutCompany.this.partLabel;
                        if (FriendSendModeLayoutCompany.this.listener != null) {
                            int unused12 = FriendSendModeLayoutCompany.this.sendTypeMode = 1;
                            FriendSendModeLayoutCompany.this.listener.sendType(FriendSendModeLayoutCompany.this.sendTypeMode);
                    ...
                    case 2131296498:
                        ...
                        FriendSendModeLayoutCompany.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused13 = FriendSendModeLayoutCompany.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutCompany.this.keyShield, 1)).intValue();
                        } catch (Exception unused14) {
                            int unused15 = FriendSendModeLayoutCompany.this.startIndexShield = 1;
                        }
                        TextView access$0003 = FriendSendModeLayoutCompany.this.start_pull;
                        access$0003.setText("从第" + FriendSendModeLayoutCompany.this.startIndexShield + "个开始");
                        FontUtils.changeFontColor(FriendSendModeLayoutCompany.this.mContext, FriendSendModeLayoutCompany.this.start_pull);
                        String unused16 = FriendSendModeLayoutCompany.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutCompany.this.keyShieldLabel, "");
                        ...
                        String unused17 = FriendSendModeLayoutCompany.this.friendsTags = FriendSendModeLayoutCompany.this.shieldLabel;
                        if (FriendSendModeLayoutCompany.this.listener != null) {
                            int unused18 = FriendSendModeLayoutCompany.this.sendTypeMode = 2;
