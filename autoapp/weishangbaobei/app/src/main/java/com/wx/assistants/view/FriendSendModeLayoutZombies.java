                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused3 = FriendSendModeLayoutZombies.this.startIndexAll = 1;
                        }
                        TextView access$000 = FriendSendModeLayoutZombies.this.start_pull;
                        access$000.setText("从第" + FriendSendModeLayoutZombies.this.startIndexAll + "个好友开始检测");
                        FontUtils.changeFontColor(FriendSendModeLayoutZombies.this.mContext, FriendSendModeLayoutZombies.this.start_pull);
                        String unused4 = FriendSendModeLayoutZombies.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyAllLabel, "");
                        ...
                        String unused5 = FriendSendModeLayoutZombies.this.friendsTags = FriendSendModeLayoutZombies.this.allLabel;
                        if (FriendSendModeLayoutZombies.this.listener != null) {
                            int unused6 = FriendSendModeLayoutZombies.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused7 = FriendSendModeLayoutZombies.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyPart, 1)).intValue();
                        } catch (Exception unused8) {
                            int unused9 = FriendSendModeLayoutZombies.this.startIndexPart = 1;
                        }
                        TextView access$0002 = FriendSendModeLayoutZombies.this.start_pull;
                        access$0002.setText("从第" + FriendSendModeLayoutZombies.this.startIndexPart + "个好友开始检测");
                        FontUtils.changeFontColor(FriendSendModeLayoutZombies.this.mContext, FriendSendModeLayoutZombies.this.start_pull);
                        String unused10 = FriendSendModeLayoutZombies.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyPartLabel, "");
                        ...
                        String unused11 = FriendSendModeLayoutZombies.this.friendsTags = FriendSendModeLayoutZombies.this.partLabel;
                        if (FriendSendModeLayoutZombies.this.listener != null) {
                            int unused12 = FriendSendModeLayoutZombies.this.sendTypeMode = 1;
                            FriendSendModeLayoutZombies.this.listener.sendType(FriendSendModeLayoutZombies.this.sendTypeMode);
                            FriendSendModeLayoutZombies.this.listener.sendStartIndex(FriendSendModeLayoutZombies.this.startIndexPart);
                        }
                        String unused13 = FriendSendModeLayoutZombies.this.partLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyPartLabelMember, "");
                    ...
                    case 2131296498:
                        ...
                        FriendSendModeLayoutZombies.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused14 = FriendSendModeLayoutZombies.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyShield, 1)).intValue();
                        } catch (Exception unused15) {
                            int unused16 = FriendSendModeLayoutZombies.this.startIndexShield = 1;
                        }
                        TextView access$0003 = FriendSendModeLayoutZombies.this.start_pull;
                        access$0003.setText("从第" + FriendSendModeLayoutZombies.this.startIndexShield + "个好友开始检测");
                        FontUtils.changeFontColor(FriendSendModeLayoutZombies.this.mContext, FriendSendModeLayoutZombies.this.start_pull);
                        String unused17 = FriendSendModeLayoutZombies.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyShieldLabel, "");
                        ...
                        String unused18 = FriendSendModeLayoutZombies.this.friendsTags = FriendSendModeLayoutZombies.this.shieldLabel;
                        if (FriendSendModeLayoutZombies.this.listener != null) {
                            int unused19 = FriendSendModeLayoutZombies.this.sendTypeMode = 2;
                            FriendSendModeLayoutZombies.this.listener.sendStartIndex(FriendSendModeLayoutZombies.this.startIndexShield);
                            FriendSendModeLayoutZombies.this.listener.sendType(FriendSendModeLayoutZombies.this.sendTypeMode);
                        }
                        String unused20 = FriendSendModeLayoutZombies.this.shieldLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayoutZombies.this.keyShieldLabelMember, "");
