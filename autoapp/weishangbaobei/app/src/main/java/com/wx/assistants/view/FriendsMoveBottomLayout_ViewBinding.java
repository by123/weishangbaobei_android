...
public class FriendsMoveBottomLayout_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r1v3, types: [android.view.View$OnClickListener, com.wx.assistants.view.FriendsMoveBottomLayout_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r1v7, types: [android.view.View$OnClickListener, com.wx.assistants.view.FriendsMoveBottomLayout_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r1v11, types: [android.view.View$OnClickListener, com.wx.assistants.view.FriendsMoveBottomLayout_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v10, types: [android.view.View$OnClickListener, com.wx.assistants.view.FriendsMoveBottomLayout_ViewBinding$4] */
    @UiThread
