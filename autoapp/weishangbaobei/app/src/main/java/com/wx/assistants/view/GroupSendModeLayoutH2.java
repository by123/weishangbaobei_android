                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused3 = GroupSendModeLayoutH2.this.startIndexAll = 1;
                        }
                        TextView access$000 = GroupSendModeLayoutH2.this.start_pull;
                        access$000.setText("从第" + GroupSendModeLayoutH2.this.startIndexAll + "个微信群开始");
                        FontUtils.changeFontColor(GroupSendModeLayoutH2.this.mContext, GroupSendModeLayoutH2.this.start_pull);
                        String unused4 = GroupSendModeLayoutH2.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH2.this.keyAllLabel, "");
                        ...
                        String unused5 = GroupSendModeLayoutH2.this.groupsTags = GroupSendModeLayoutH2.this.allLabel;
                        if (GroupSendModeLayoutH2.this.listener != null) {
                            int unused6 = GroupSendModeLayoutH2.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused7 = GroupSendModeLayoutH2.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH2.this.keyPart, 1)).intValue();
                        } catch (Exception unused8) {
                            int unused9 = GroupSendModeLayoutH2.this.startIndexPart = 1;
                        }
                        ...
                        FontUtils.changeFontColor(GroupSendModeLayoutH2.this.mContext, GroupSendModeLayoutH2.this.start_pull);
                        String unused10 = GroupSendModeLayoutH2.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH2.this.keyPartLabel, "");
                        ...
                        String unused11 = GroupSendModeLayoutH2.this.groupsTags = GroupSendModeLayoutH2.this.partLabel;
                        if (GroupSendModeLayoutH2.this.listener != null) {
                            int unused12 = GroupSendModeLayoutH2.this.sendTypeMode = 1;
                            GroupSendModeLayoutH2.this.listener.sendType(GroupSendModeLayoutH2.this.sendTypeMode);
                    ...
                    case 2131296498:
                        ...
                        GroupSendModeLayoutH2.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused13 = GroupSendModeLayoutH2.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH2.this.keyShield, 1)).intValue();
                        } catch (Exception unused14) {
                            int unused15 = GroupSendModeLayoutH2.this.startIndexShield = 1;
                        }
                        ...
                        FontUtils.changeFontColor(GroupSendModeLayoutH2.this.mContext, GroupSendModeLayoutH2.this.start_pull);
                        String unused16 = GroupSendModeLayoutH2.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH2.this.keyShieldLabel, "");
                        ...
                        String unused17 = GroupSendModeLayoutH2.this.groupsTags = GroupSendModeLayoutH2.this.shieldLabel;
                        if (GroupSendModeLayoutH2.this.listener != null) {
                            int unused18 = GroupSendModeLayoutH2.this.sendTypeMode = 2;
