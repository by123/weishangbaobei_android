...
public class RightDiaView extends View {
    ...
    private void drawDynamic(Canvas canvas) {
        ...
        if (this.progress == 100) {
            ...
            canvas.drawLine((float) ((this.line1_x + i2) - 1), (float) ((this.line1_y + i) - 4), (float) (i2 + this.line2_x), (float) (i + this.line2_y), this.mPaint);
        }
    ...
    private void drawStatic(Canvas canvas) {
        ...
        canvas2.drawLine((float) i2, (float) i, (float) i5, (float) i6, this.mPaint);
        canvas2.drawLine((float) (i5 - 1), (float) (i6 - 4), (float) (i2 + i3), (float) (i - i4), this.mPaint);
    }
