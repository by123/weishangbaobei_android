...
public class WrongDiaView extends View {
    ...
    private void drawStatic(Canvas canvas) {
        ...
        float f = (float) i;
        float f2 = f;
        canvas.drawLine(f, f2, (float) (((this.mWidth * 2) / 5) + i), (float) (((this.mWidth * 2) / 5) + i), this.mPaint);
        canvas.drawLine((float) (((this.mWidth * 2) / 5) + i), f2, f, (float) (i + ((this.mWidth * 2) / 5)), this.mPaint);
    }
