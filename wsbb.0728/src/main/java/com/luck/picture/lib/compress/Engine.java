...
class Engine {
    ...
    private Bitmap rotatingImage(Bitmap bitmap) {
        ...
        matrix.postRotate((float) (attributeInt != 3 ? attributeInt != 6 ? attributeInt != 8 ? 0 : SubsamplingScaleImageView.ORIENTATION_270 : 90 : SubsamplingScaleImageView.ORIENTATION_180));
