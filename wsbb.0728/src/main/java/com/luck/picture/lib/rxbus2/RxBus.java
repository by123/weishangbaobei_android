...
public class RxBus {
    ...
    private void addSubscriber(final SubscriberMethod subscriberMethod) {
        addSubscriptionToMap(subscriberMethod.subscriber.getClass(), postToObservable(subscriberMethod.code == -1 ? toObservable(subscriberMethod.eventType) : toObservable(subscriberMethod.code, subscriberMethod.eventType), subscriberMethod).subscribe(new Consumer<Object>() {
