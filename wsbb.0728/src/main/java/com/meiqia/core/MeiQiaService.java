...
public class MeiQiaService extends Service {
    ...
    public void a() {
        ...
        AnonymousClass2 r2 = new X509TrustManager() {
        ...
        if (sSLContext == null) {
            this.k = builder222.sslSocketFactory(sSLContext.getSocketFactory(), r2).hostnameVerifier(new HostnameVerifier() {
    ...
    public long k() {
        ...
        return (long) (i2 + (this.f * CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION));
    }
    ...
    public int onStartCommand(Intent intent, int i2, int i3) {
        ...
        if ("ACTION_OPEN_SOCKET".equals(intent != null ? intent.getAction() : "ACTION_OPEN_SOCKET")) {
            ...
            this.n = intent != null && intent.getBooleanExtra("KEY_BOOLEAN_SYNC_MSG", false);
            b();
        } else {
            c();
        }
