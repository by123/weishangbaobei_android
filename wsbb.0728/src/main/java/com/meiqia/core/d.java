...
class d {
        ...
        for (String a2 : list2) {
            ...
            a("photo", a2, (g.j) new g.j() {
                public void a(String str, String str2) {
                    ...
                    list3.add(mQMessage);
                    if (iArr[0] + iArr[1] != list4.size()) {
                        return;
                    }
                    if (iArr[0] == list4.size()) {
                ...
                public void onFailure(int i, String str) {
                    iArr[1] = iArr[1] + 1;
                    if (iArr[0] + iArr[1] == list4.size() && simpleCallback2 != null) {
                        simpleCallback2.onFailure(i, str);
                    }
                }
            });
        ...
        this.j.a((Map<String, Object>) hashMap, (g.C0000g) new g.C0000g() {
            public void a(JSONArray jSONArray) {
                ...
                while (true) {
                    ...
                    MQMessage mQMessage = (MQMessage) list.get(i2);
    ...
    public void a(int i2, int i3, long j2, int i4, OnGetMessageListCallback onGetMessageListCallback) {
        ...
        this.j.a(trackId, i2, i3, parseInt, a2, i4, (OnGetMessageListCallback) new OnGetMessageListCallback() {
            public void onFailure(int i, String str) {
    ...
    public void a(MQMessage mQMessage, final OnProgressCallback onProgressCallback) {
        ...
        if (!k.a()) {
            ...
            try {
                ...
                this.j.a(mQMessage, file2, (OnProgressCallback) new OnProgressCallback() {
                    public void onFailure(final int i, final String str) {
                        d.this.a((Runnable) new Runnable() {
                            public void run() {
    ...
    public void a(final OnInitCallback onInitCallback) {
        ...
        if (!(l2 != null)) {
            ...
            onInitCallback.onSuccess(l2.getTrackId());
        }
    }
    ...
    public void a(String str, OnGetMessageListCallback onGetMessageListCallback) {
        ...
        final OnGetMessageListCallback onGetMessageListCallback2 = onGetMessageListCallback;
        this.j.a(trackId, b, 0, parseInt, a2, 1, (OnGetMessageListCallback) new OnGetMessageListCallback() {
            public void onFailure(int i, String str) {
                if (onGetMessageListCallback2 == null) {
                    return;
                }
                if (i == 404) {
                    onGetMessageListCallback2.onSuccess(new ArrayList());
                } else {
                    onGetMessageListCallback2.onFailure(i, str);
                }
            }
            ...
            public void onSuccess(List<MQMessage> list) {
                d.this.a(mQClient, a2, list, (OnGetMessageListCallback) new OnGetMessageListCallback() {
                    public void onFailure(int i, String str) {
                        if (onGetMessageListCallback2 == null) {
                            return;
                        }
