...
public class LiquidCircleView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(this.mWidth / 2.0f, this.mHeight / 2.0f, this.mSize / 2.0f, this.mPaint);
        ...
        float f3 = f / 2.0f;
        float f4 = f2 - f3;
        canvas.drawArc(this.mRectF, f4, f, false, this.mPaint);
        double d = (double) (this.mSize / 2.0f);
        double d2 = (double) (f4 + 90.0f);
        Double.isNaN(d2);
        ...
        Double.isNaN(d8);
        float f5 = (float) ((sin2 * d) + d8);
        double d9 = (double) (this.mHeight / 2.0f);
        double cos2 = Math.cos(d7);
        Double.isNaN(d);
        Double.isNaN(d9);
        this.mPaint.setStyle(Paint.Style.FILL);
        canvas.drawCircle((float) ((sin * d) + d4), (float) (d5 - (cos * d)), this.strokeWidth / 2.0f, this.mPaint);
        canvas.drawCircle(f5, (float) (d9 - (d * cos2)), this.strokeWidth / 2.0f, this.mPaint);
        if (isShown()) {
            invalidate();
        }
    }
