...
public class BezierCircleHeader extends InternalAbstract implements RefreshHeader {
    ...
    private void drawFinish(Canvas canvas, int i) {
        if (this.mFinishRatio > CropImageView.DEFAULT_ASPECT_RATIO) {
            ...
            if (((double) this.mFinishRatio) < 0.3d) {
                ...
                canvas.drawArc(new RectF((float) (i2 - strokeWidth), this.mBollY - f, (float) (i2 + strokeWidth), this.mBollY + f), CropImageView.DEFAULT_ASPECT_RATIO, 360.0f, false, this.mOuterPaint);
            }
            ...
            if (((double) this.mFinishRatio) >= 0.7d && this.mFinishRatio <= 1.0f) {
                ...
                float f4 = (float) (i / 2);
                int i3 = (int) ((f4 - this.mBollRadius) - ((this.mBollRadius * 2.0f) * f3));
                this.mPath.reset();
                this.mPath.moveTo((float) i3, this.mHeadHeight);
                this.mPath.quadTo(f4, this.mHeadHeight - ((1.0f - f3) * this.mBollRadius), (float) (i - i3), this.mHeadHeight);
                canvas.drawPath(this.mPath, this.mFrontPaint);
            }
        }
    }
    ...
    private void drawOuter(Canvas canvas, int i) {
        int i2 = 3;
        if (this.mShowOuter) {
            float strokeWidth = (this.mOuterPaint.getStrokeWidth() * 2.0f) + this.mBollRadius;
            this.mRefreshStart = (this.mOuterIsStart ? 3 : 10) + this.mRefreshStart;
            ...
            float f = (float) (i / 2);
            canvas.drawArc(new RectF(f - strokeWidth, this.mBollY - strokeWidth, f + strokeWidth, strokeWidth + this.mBollY), (float) this.mRefreshStart, (float) i5, false, this.mOuterPaint);
            if (i5 >= 270) {
