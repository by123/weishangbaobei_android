...
public class DropBoxHeader extends InternalAbstract implements RefreshHeader {
    ...
    private Path generateBoxCoverPath(BoxBody boxBody) {
        ...
        this.mPath.lineTo(((float) boxBody.boxLeft) - sin2, cos2 + ((float) boxBody.boxCenterTop));
        this.mPath.close();
        ...
        this.mPath.lineTo(sin3 + ((float) boxBody.boxRight), ((float) boxBody.boxCenterTop) - cos3);
        this.mPath.close();
        ...
        this.mPath.lineTo(sin4 + ((float) boxBody.boxRight), cos4 + ((float) boxBody.boxCenterTop));
        this.mPath.close();
        return this.mPath;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.mDropOutPercent > CropImageView.DEFAULT_ASPECT_RATIO) {
            ...
            int i = width / 2;
            bounds.offsetTo(i - (bounds.width() / 2), ((int) (min * ((float) ((generateBoxBody.boxCenterY - (bounds.height() / 2)) + bounds.height())))) - bounds.height());
            ...
            bounds2.offsetTo(i - (bounds2.width() / 2), ((int) (min2 * ((float) ((generateBoxBody.boxCenterY - (bounds2.height() / 2)) + bounds2.height())))) - bounds2.height());
            ...
            bounds3.offsetTo(i - (bounds3.width() / 2), ((int) (min3 * ((float) ((generateBoxBody.boxCenterY - (bounds3.height() / 2)) + bounds3.height())))) - bounds3.height());
