...
public class FunGameBattleCityHeader extends FunGameView {
    ...
    public void drawSelfTank(Canvas canvas, int i) {
        ...
        canvas2.drawRect((float) (i - this.controllerSize), this.DIVIDING_LINE_SIZE + this.controllerPosition, (float) i, this.DIVIDING_LINE_SIZE + this.controllerPosition + ((float) this.controllerSize), this.mPaint);
        Canvas canvas3 = canvas;
        canvas3.drawRect((float) ((i - this.controllerSize) - this.barrelSize), (((float) (this.controllerSize - this.barrelSize)) * 0.5f) + this.controllerPosition, (float) (i - this.controllerSize), ((float) this.barrelSize) + this.controllerPosition + (((float) (this.controllerSize - this.barrelSize)) * 0.5f), this.mPaint);
    }
    ...
    public void drawTank(Canvas canvas, RectF rectF) {
        ...
        Canvas canvas2 = canvas;
        canvas2.drawRect(rectF.right, f, ((float) this.barrelSize) + rectF.right, f + ((float) this.barrelSize), this.mPaint);
    }

    /* access modifiers changed from: protected */
    public RectF generateEnemyTank(int i) {
        float f = (float) (-(this.controllerSize + this.barrelSize));
        float f2 = ((float) (this.controllerSize * i)) + this.DIVIDING_LINE_SIZE;
