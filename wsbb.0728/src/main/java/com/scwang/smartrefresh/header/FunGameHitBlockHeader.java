...
public class FunGameHitBlockHeader extends FunGameView {
    ...
    public void drawColorBlock(Canvas canvas) {
        ...
        for (int i = 0; i < this.blockHorizontalNum * 5; i++) {
            ...
            if (!z) {
                ...
                float f = (((float) i3) * (this.blockWidth + 1.0f)) + this.blockLeft;
    ...
    public void drawRacket(Canvas canvas) {
        ...
        canvas2.drawRect(this.racketLeft, this.controllerPosition, this.blockWidth + this.racketLeft, ((float) this.controllerSize) + this.controllerPosition, this.mPaint);
    }
