...
public abstract class FunGameView<T extends FunGameView> extends FunGameBase {
    ...
    private void drawBoundary(Canvas canvas, int i, int i2) {
        ...
        float f = (float) i;
        float f2 = (float) i2;
        canvas.drawRect(CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, f, f2, this.mPaint);
        this.mPaint.setColor(this.mBoundaryColor);
        canvas.drawLine(CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, f, CropImageView.DEFAULT_ASPECT_RATIO, this.mPaint);
        canvas.drawLine(CropImageView.DEFAULT_ASPECT_RATIO, f2 - this.DIVIDING_LINE_SIZE, f, f2 - this.DIVIDING_LINE_SIZE, this.mPaint);
    }
