...
public class r {
    ...
    public static WifiInfo c(Context context) {
        ...
        if (!a(context, "android.permission.ACCESS_WIFI_STATE") || (wifiManager = (WifiManager) StubApp.getOrigApplicationContext(context.getApplicationContext()).getSystemService("wifi")) == null) {
            return null;
        }
