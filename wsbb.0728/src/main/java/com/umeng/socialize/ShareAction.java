...
public class ShareAction {
    ...
    private ShareBoardlistener defaultmulshareboardlistener = new ShareBoardlistener() {
        public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
            ...
            if (size != 0) {
                ShareContent unused = ShareAction.this.mShareContent = indexOf < size ? (ShareContent) ShareAction.this.contentlist.get(indexOf) : (ShareContent) ShareAction.this.contentlist.get(size - 1);
            }
