...
public class TextureRenderer {
    ...
    private static final float[] mTriangleVerticesData = {-1.0f, -1.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, -1.0f, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO, -1.0f, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, 1.0f, 1.0f, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f, 1.0f};
                    ...
                    if (this.muMVPMatrixHandle != -1) {
                        ...
                        if (this.muSTMatrixHandle != -1) {
                            ...
                            if (this.rotationAngle != 0) {
                                Matrix.rotateM(this.mMVPMatrix, 0, (float) this.rotationAngle, CropImageView.DEFAULT_ASPECT_RATIO, CropImageView.DEFAULT_ASPECT_RATIO, 1.0f);
                                return;
                            }
                            return;
                        }
