...
public class Track {
    ...
    public void addSample(long j, MediaCodec.BufferInfo bufferInfo) {
        ...
        long j4 = (((j2 - j3) * ((long) this.timeScale)) + 500000) / 1000000;
        if (!this.first) {
            this.sampleDurations.add(this.sampleDurations.size() - 1, Long.valueOf(j4));
    ...
    public long[] getSyncSamples() {
        ...
        while (true) {
            ...
            jArr[i2] = (long) this.syncSamples.get(i2).intValue();
            i = i2 + 1;
        }
    }
