...
public class ActivationActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.ActivationActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.ActivationActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v41, types: [android.view.View$OnClickListener, com.wx.assistants.activity.ActivationActivity_ViewBinding$3] */
    @UiThread
