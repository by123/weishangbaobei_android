...
public class AutoAddContactCameraActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.AutoAddContactCameraActivity] */
    @Subscribe
    ...
    public void recognize(String str) {
        try {
            ...
            RecognizeService.recGeneralBasic(this, str, new RecognizeService.ServiceListener() {
                /* JADX WARNING: type inference failed for: r0v9, types: [android.content.Context, com.wx.assistants.activity.AutoAddContactCameraActivity] */
                /* JADX WARNING: type inference failed for: r0v11, types: [android.content.Context, com.wx.assistants.activity.AutoAddContactCameraActivity] */
                public void onResult(String str) {
                    ...
                    if (str != null) {
                        ...
                        if (hashSet.size() > 0) {
                            ...
                            try {
                                ? r0 = AutoAddContactCameraActivity.this;
                                DialogUIUtils.dialogDefault(r0, "识别结果", "系统识别到了" + hashSet.size() + "个手机号，已帮您保存到通讯录。", "", "确定", (View.OnClickListener) null, new View.OnClickListener() {
                                    /* JADX WARNING: type inference failed for: r1v1, types: [android.content.Context, com.wx.assistants.activity.AutoAddContactCameraActivity] */
    ...
    public void resultFail() {
        DialogUIUtils.dialogDefault(this, "识别结果", this.type == 0 ? "系统未识别到手机号码！是否重新拍照" : "系统未识别到手机号码！是否重新选择", "取消", this.type == 0 ? "重新拍照" : "重新选择", (View.OnClickListener) null, new View.OnClickListener() {
            public void onClick(View view) {
                if (AutoAddContactCameraActivity.this.type == 0) {
                    AutoAddContactCameraActivity.this.goCamera();
                } else {
