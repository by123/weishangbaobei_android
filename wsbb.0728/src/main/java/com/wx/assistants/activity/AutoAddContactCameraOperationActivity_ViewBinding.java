...
public class AutoAddContactCameraOperationActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v10, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddContactCameraOperationActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddContactCameraOperationActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v20, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddContactCameraOperationActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v28, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddContactCameraOperationActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r0v39, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoAddContactCameraOperationActivity_ViewBinding$5] */
    @UiThread
