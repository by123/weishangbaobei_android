...
public class AutoPullFriendsToGroupActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoPullFriendsToGroupActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.AutoPullFriendsToGroupActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v20, types: [com.wx.assistants.activity.AutoPullFriendsToGroupActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v31, types: [com.wx.assistants.activity.AutoPullFriendsToGroupActivity_ViewBinding$4, android.view.View$OnClickListener] */
    @UiThread
