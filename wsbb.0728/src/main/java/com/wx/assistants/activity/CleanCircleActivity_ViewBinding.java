...
public class CleanCircleActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v9, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v17, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v22, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r0v27, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$5] */
    /* JADX WARNING: type inference failed for: r0v32, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$6] */
    /* JADX WARNING: type inference failed for: r0v43, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$7] */
    /* JADX WARNING: type inference failed for: r0v48, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanCircleActivity_ViewBinding$8] */
    @UiThread
