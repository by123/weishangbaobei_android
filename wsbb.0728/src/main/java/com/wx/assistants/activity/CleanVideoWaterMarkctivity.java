...
public class CleanVideoWaterMarkctivity extends BaseActivity {
            ...
            CheckRuleValidateUtils.getInstance(this).checkRuleValidate("41", new CheckRuleValidateUtils.CheckResultListener() {
                ...
                public void changeDevice(Object obj) {
                    ...
                    DialogUIUtils.dialogChangerDevice(CleanVideoWaterMarkctivity.this, new View.OnClickListener() {
                        /* JADX WARNING: type inference failed for: r2v1, types: [android.content.Context, com.wx.assistants.activity.CleanVideoWaterMarkctivity] */
    ...
    /* JADX WARNING: type inference failed for: r6v0, types: [android.content.Context, com.wx.assistants.activity.CleanVideoWaterMarkctivity] */
    public void getVideo() {
        if (this.isCanClicked) {
            ...
            instance.getWaterMark(trim, valueOf + "", str, "944cd0718a62665e", new ApiWrapper2.CallbackListener2<WaterMarkResultModel>() {
                ...
                /* JADX WARNING: type inference failed for: r0v8, types: [android.content.Context, com.wx.assistants.activity.CleanVideoWaterMarkctivity] */
                /* JADX WARNING: type inference failed for: r1v6, types: [android.content.Context, com.wx.assistants.activity.CleanVideoWaterMarkctivity] */
                public void onFinish(final WaterMarkResultModel waterMarkResultModel) {
                    ...
                    if (waterMarkResultModel.isSucc()) {
                        ...
                        if (data != null) {
                            boolean unused = CleanVideoWaterMarkctivity.this.isCanClicked = false;
                            String unused2 = CleanVideoWaterMarkctivity.this.videoUrl = data.getVideo();
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.CleanVideoWaterMarkctivity, android.app.Activity] */
