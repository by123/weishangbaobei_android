...
public class CleanVideoWaterMarkctivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [com.wx.assistants.activity.CleanVideoWaterMarkctivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v18, types: [com.wx.assistants.activity.CleanVideoWaterMarkctivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v23, types: [com.wx.assistants.activity.CleanVideoWaterMarkctivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v37, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CleanVideoWaterMarkctivity_ViewBinding$4] */
    @UiThread
