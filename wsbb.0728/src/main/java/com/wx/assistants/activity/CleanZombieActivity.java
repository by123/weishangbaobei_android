                    ...
                    try {
                        if (conmdBean.getCode() == 0 && (list = (List) conmdBean.getData()) != null && list.size() > 0) {
                            ...
                            while (true) {
                                int i2 = i;
                                if (i2 < list.size()) {
                                    String scrollBar = ((HomeBannerBean) list.get(i2)).getScrollBar();
                                    if (scrollBar != null) {
                                        strArr[i2] = scrollBar;
                                    } else {
                                        strArr[i2] = MyApplication.checkStr[0];
                                    }
                                    i = i2 + 1;
                                } else {
        ...
        startCheck("1", true, new BaseActivity.OnStartCheckListener() {
            public void checkEnd() {
                ...
                ApiWrapper.getInstance().getVersion(new ApiWrapper.CallbackListener<ConmdBean<AppVersionModel>>() {
                    ...
                    /* JADX WARNING: type inference failed for: r0v8, types: [android.content.Context, com.wx.assistants.activity.CleanZombieActivity] */
