...
public class CleanZombieDNDActivity extends BaseActivity {
                ...
                if (conmdBean != null) {
                    try {
                        if ((conmdBean.getCode() != 1 || conmdBean.getMessage() == null) && conmdBean.getCode() == 0) {
                            ...
                            CleanZombieDNDActivity.this.setUserInfo(json);
                        }
                    } catch (Exception e2) {
                        e2.printStackTrace();
                    }
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [com.wx.assistants.activity.CleanZombieDNDActivity, android.content.Context] */
    ...
    public void onViewClicked(View view) {
        ...
        if (id == 2131297049) {
            ...
            startCheck(this.dndModel == 0 ? "27" : this.dndModel == 3 ? "58" : "38", true, new BaseActivity.OnStartCheckListener() {
