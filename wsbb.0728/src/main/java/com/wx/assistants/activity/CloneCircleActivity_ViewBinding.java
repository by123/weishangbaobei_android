...
public class CloneCircleActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CloneCircleActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CloneCircleActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v23, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CloneCircleActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v28, types: [android.view.View$OnClickListener, com.wx.assistants.activity.CloneCircleActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r0v33, types: [com.wx.assistants.activity.CloneCircleActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v41, types: [com.wx.assistants.activity.CloneCircleActivity_ViewBinding$6, android.view.View$OnClickListener] */
    @UiThread
