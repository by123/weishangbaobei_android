...
public class CopyFriendRecoverActivity extends BaseActivity implements View.OnClickListener {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        /* JADX WARNING: type inference failed for: r1v13, types: [android.content.Context, com.wx.assistants.activity.CopyFriendRecoverActivity] */
        @SuppressLint({"NewApi"})
    ...
    private void initView() {
        ...
        this.contact_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            /* JADX WARNING: type inference failed for: r0v24, types: [android.content.Context, com.wx.assistants.activity.CopyFriendRecoverActivity] */
    ...
    public void onClick(View view) {
        ...
        if (id == 2131297049) {
            ...
            while (true) {
                ...
                CopyFriendBean copyFriendBean = this.recoverFriendBeanList.get(i2);
