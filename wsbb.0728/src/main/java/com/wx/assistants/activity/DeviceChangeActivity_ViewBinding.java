...
public class DeviceChangeActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v9, types: [com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v14, types: [android.view.View$OnClickListener, com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v19, types: [com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v24, types: [com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v32, types: [com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v37, types: [com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$7, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v42, types: [android.view.View$OnClickListener, com.wx.assistants.activity.DeviceChangeActivity_ViewBinding$8] */
    @UiThread
