...
public class GoMakeMoneyActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [android.content.Context, com.wx.assistants.activity.GoMakeMoneyActivity] */
        ...
        switch (view.getId()) {
            ...
            case 2131296819:
                ...
                new AlertActionSheetSharedDialog(this, new AlertActionSheetSharedDialog.OnSheetItemClickListener() {
                    ...
                    /* JADX WARNING: type inference failed for: r2v2, types: [android.content.Context, com.wx.assistants.activity.GoMakeMoneyActivity] */
                    /* JADX WARNING: type inference failed for: r2v3, types: [android.app.Activity, com.wx.assistants.activity.GoMakeMoneyActivity] */
