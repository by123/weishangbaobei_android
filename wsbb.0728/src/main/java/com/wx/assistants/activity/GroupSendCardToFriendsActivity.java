...
public class GroupSendCardToFriendsActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendCardToFriendsActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendCardToFriendsActivity] */
