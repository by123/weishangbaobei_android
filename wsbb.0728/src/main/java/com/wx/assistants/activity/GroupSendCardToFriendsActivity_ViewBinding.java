...
public class GroupSendCardToFriendsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v10, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToFriendsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v18, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToFriendsActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v23, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendCardToFriendsActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v28, types: [com.wx.assistants.activity.GroupSendCardToFriendsActivity_ViewBinding$4, android.view.View$OnClickListener] */
    @UiThread
