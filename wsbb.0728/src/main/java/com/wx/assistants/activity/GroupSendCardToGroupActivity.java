...
public class GroupSendCardToGroupActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendCardToGroupActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendCardToGroupActivity] */
