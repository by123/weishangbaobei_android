...
public class GroupSendCollectionToGroupActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendCollectionToGroupActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendCollectionToGroupActivity] */
