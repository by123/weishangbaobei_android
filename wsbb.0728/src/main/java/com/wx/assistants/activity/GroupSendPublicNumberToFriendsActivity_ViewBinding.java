...
public class GroupSendPublicNumberToFriendsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendPublicNumberToFriendsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendPublicNumberToFriendsActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v20, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendPublicNumberToFriendsActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v25, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendPublicNumberToFriendsActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r0v33, types: [com.wx.assistants.activity.GroupSendPublicNumberToFriendsActivity_ViewBinding$5, android.view.View$OnClickListener] */
    @UiThread
