...
public class GroupSendTextImageToGroupActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v9, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v14, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v22, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r0v27, types: [com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v32, types: [com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v40, types: [com.wx.assistants.activity.GroupSendTextImageToGroupActivity_ViewBinding$7, android.view.View$OnClickListener] */
    @UiThread
