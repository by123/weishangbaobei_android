...
public class GroupSendVoiceToFriendsActivity extends BaseActivity {
                ...
                if (conmdBean != null) {
                    try {
                        if ((conmdBean.getCode() != 1 || conmdBean.getMessage() == null) && conmdBean.getCode() == 0) {
                            ...
                            GroupSendVoiceToFriendsActivity.this.setUserInfo(json);
                        }
                    } catch (Exception e2) {
                        e2.printStackTrace();
                    }
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendVoiceToFriendsActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.content.Context, com.wx.assistants.activity.GroupSendVoiceToFriendsActivity] */
