...
public class GroupSendVoiceToFriendsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v7, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v15, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v20, types: [com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v25, types: [com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v33, types: [com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v38, types: [android.view.View$OnClickListener, com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$6] */
    /* JADX WARNING: type inference failed for: r0v64, types: [com.wx.assistants.activity.GroupSendVoiceToFriendsActivity_ViewBinding$7, android.view.View$OnClickListener] */
    @UiThread
