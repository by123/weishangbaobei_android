...
public class InviteRecordActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.InviteRecordActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v18, types: [android.view.View$OnClickListener, com.wx.assistants.activity.InviteRecordActivity_ViewBinding$2] */
    @UiThread
