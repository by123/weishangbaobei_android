...
public class LabelRemarkActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        this.labelAutoBatchLayout.setOnAutoBatchModelListener(new LabelAutoBatchLayout.OnAutoBatchModelListener() {
            /* JADX WARNING: type inference failed for: r0v1, types: [android.content.Context, com.wx.assistants.activity.LabelRemarkActivity] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.LabelRemarkActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [android.content.Context, com.wx.assistants.activity.LabelRemarkActivity] */
