...
public class MemberCenterPassiveCardActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v9, types: [com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v14, types: [com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v19, types: [android.view.View$OnClickListener, com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$4] */
    /* JADX WARNING: type inference failed for: r0v33, types: [com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v44, types: [com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v49, types: [com.wx.assistants.activity.MemberCenterPassiveCardActivity_ViewBinding$7, android.view.View$OnClickListener] */
    @UiThread
