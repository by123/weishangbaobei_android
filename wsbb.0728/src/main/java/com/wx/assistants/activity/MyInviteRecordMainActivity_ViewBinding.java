...
public class MyInviteRecordMainActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.MyInviteRecordMainActivity_ViewBinding$1] */
    @UiThread
