...
public class ObtainSingleTagCompanyActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.ObtainSingleTagCompanyActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.content.Context, com.wx.assistants.activity.ObtainSingleTagCompanyActivity] */
