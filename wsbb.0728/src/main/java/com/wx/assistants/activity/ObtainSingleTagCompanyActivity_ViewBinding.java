...
public class ObtainSingleTagCompanyActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [com.wx.assistants.activity.ObtainSingleTagCompanyActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v12, types: [com.wx.assistants.activity.ObtainSingleTagCompanyActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v17, types: [com.wx.assistants.activity.ObtainSingleTagCompanyActivity_ViewBinding$3, android.view.View$OnClickListener] */
    @UiThread
