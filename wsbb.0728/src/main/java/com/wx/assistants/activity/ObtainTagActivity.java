...
public class ObtainTagActivity extends BaseActivity {
            ...
            if (this.labelList != null && !this.labels.isEmpty()) {
                ...
                if (this.labList != null && this.labList.size() > 0) {
                    ...
                    this.myListAdapter.setOnClickTagNameListener(new MyListAdapter.OnClickTagNameListener() {
                        /* JADX WARNING: type inference failed for: r1v2, types: [android.content.Context, com.wx.assistants.activity.ObtainTagActivity] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.ObtainTagActivity] */
    @Subscribe
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [android.content.Context, com.wx.assistants.activity.ObtainTagActivity] */
