...
public class OneDayActivationCodeActivity extends BaseActivity {
    ...
    public void initOneDayActivationCodeData() {
        ApiWrapper.getInstance().myActivationCode(MacAddressUtils.getMacAddress(MyApplication.mContext), new ApiWrapper.CallbackListener<ConmdBean>() {
            ...
            /* JADX WARNING: type inference failed for: r0v5, types: [android.content.Context, com.wx.assistants.activity.OneDayActivationCodeActivity] */
            /* JADX WARNING: type inference failed for: r2v2, types: [android.content.Context, com.wx.assistants.activity.OneDayActivationCodeActivity] */
            /* JADX WARNING: type inference failed for: r2v3, types: [android.content.Context, com.wx.assistants.activity.OneDayActivationCodeActivity] */
            /* JADX WARNING: type inference failed for: r5v0, types: [android.content.Context, com.wx.assistants.activity.OneDayActivationCodeActivity] */
                            ...
                            OneDayActivationCodeActivity.this.recyclerView.setAdapter(new BaseRecyclerAdapter<ActivationCodeBean>(OneDayActivationCodeActivity.this.items, 2131427479, (AdapterView.OnItemClickListener) null) {
                                ...
                                public void onBindViewHolder(SmartViewHolder smartViewHolder, final ActivationCodeBean activationCodeBean, int i) {
                                    ...
                                    smartViewHolder.click(2131296313, new View.OnClickListener() {
                                        /* JADX WARNING: type inference failed for: r0v7, types: [android.content.Context, com.wx.assistants.activity.OneDayActivationCodeActivity] */
