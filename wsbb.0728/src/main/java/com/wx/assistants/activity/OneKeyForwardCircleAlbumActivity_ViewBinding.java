...
public class OneKeyForwardCircleAlbumActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [com.wx.assistants.activity.OneKeyForwardCircleAlbumActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v15, types: [com.wx.assistants.activity.OneKeyForwardCircleAlbumActivity_ViewBinding$2, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v20, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardCircleAlbumActivity_ViewBinding$3] */
    /* JADX WARNING: type inference failed for: r0v31, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyForwardCircleAlbumActivity_ViewBinding$4] */
    @UiThread
