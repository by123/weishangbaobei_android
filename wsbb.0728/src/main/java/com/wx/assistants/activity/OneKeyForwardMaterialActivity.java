...
public class OneKeyForwardMaterialActivity extends BaseActivity {
    ...
    /* JADX WARNING: type inference failed for: r6v0, types: [android.content.Context, com.wx.assistants.activity.OneKeyForwardMaterialActivity] */
    public void initViewData(final boolean z, int i) {
        ...
        ApiWrapper.getInstance().materialList(i, 5, MacAddressUtils.getMacAddress(MyApplication.mContext), (String) SPUtils.get(this, "user_token", ""), new ApiWrapper.CallbackListener<ConmdListBean>() {
            ...
            /* JADX WARNING: type inference failed for: r0v7, types: [android.content.Context, com.wx.assistants.activity.OneKeyForwardMaterialActivity] */
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [android.content.Context, com.wx.assistants.activity.OneKeyForwardMaterialActivity] */
    @Subscribe
