...
public class OneKeyLikeCommentToFriendsActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v10, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v18, types: [android.view.View$OnClickListener, com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v23, types: [com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v28, types: [com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$4, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v36, types: [com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$5, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v50, types: [com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$6, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v58, types: [com.wx.assistants.activity.OneKeyLikeCommentToFriendsActivity_ViewBinding$7, android.view.View$OnClickListener] */
    @UiThread
