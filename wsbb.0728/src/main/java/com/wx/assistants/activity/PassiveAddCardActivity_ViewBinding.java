...
public class PassiveAddCardActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [com.wx.assistants.activity.PassiveAddCardActivity_ViewBinding$1, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v12, types: [android.view.View$OnClickListener, com.wx.assistants.activity.PassiveAddCardActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v17, types: [com.wx.assistants.activity.PassiveAddCardActivity_ViewBinding$3, android.view.View$OnClickListener] */
    /* JADX WARNING: type inference failed for: r0v25, types: [android.view.View$OnClickListener, com.wx.assistants.activity.PassiveAddCardActivity_ViewBinding$4] */
    @UiThread
