...
public class PreviewMultiImageActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [com.wx.assistants.activity.PreviewMultiImageActivity_ViewBinding$1, android.view.View$OnClickListener] */
    @UiThread
