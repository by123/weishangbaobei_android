...
public class VoiceForwardActivity_ViewBinding implements Unbinder {
    ...
    /* JADX WARNING: type inference failed for: r0v4, types: [android.view.View$OnClickListener, com.wx.assistants.activity.VoiceForwardActivity_ViewBinding$1] */
    /* JADX WARNING: type inference failed for: r0v12, types: [android.view.View$OnClickListener, com.wx.assistants.activity.VoiceForwardActivity_ViewBinding$2] */
    /* JADX WARNING: type inference failed for: r0v17, types: [com.wx.assistants.activity.VoiceForwardActivity_ViewBinding$3, android.view.View$OnClickListener] */
    @UiThread
