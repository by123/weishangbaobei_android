...
public class WechatImagesSlicerActivity extends BaseActivity implements View.OnClickListener {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [com.wx.assistants.activity.WechatImagesSlicerActivity, android.content.Context] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public static /* synthetic */ void lambda$save$2(WechatImagesSlicerActivity r3, Throwable th) throws Exception {
        th.printStackTrace();
        Toast.makeText(r3, "导出失败", 0).show();
        r3.progressView.setVisibility(8);
        r3.resultView.setVisibility(8);
    }
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [com.wx.assistants.activity.WechatImagesSlicerActivity, com.wx.assistants.base.BaseActivity, android.content.Context, android.app.Activity] */
        ...
        if (view.getId() == 2131297364) {
            ...
            if (!isAccessibilitySettingsOn()) {
                ...
                checkUserRule(operationParameterModel, new CheckRuleValidateUtils.CheckResultListener2() {
                    public static /* synthetic */ Uri lambda$permitExecution$0(AnonymousClass4 r8, File file) throws Exception {
