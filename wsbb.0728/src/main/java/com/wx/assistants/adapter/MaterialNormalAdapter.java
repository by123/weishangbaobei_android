...
public class MaterialNormalAdapter extends RecyclerView.Adapter<VH> {
        ...
        if (getItemViewType(i) != 0) {
            ...
            if (materialBean.getPicUrlJson() != null && !"".equals(materialBean.getPicUrlJson())) {
                ...
                for (String str : strArr) {
                    this.picItemUrls.add(QBangApis.IMG_PREFIX_URL + str);
                }
            }
    ...
    public VH onCreateViewHolder(ViewGroup viewGroup, int i) {
        return (this.mHeaderView == null || i != 0) ? new VH(LayoutInflater.from(viewGroup.getContext()).inflate(2131427582, viewGroup, false)) : new VH(this.mHeaderView);
    }
