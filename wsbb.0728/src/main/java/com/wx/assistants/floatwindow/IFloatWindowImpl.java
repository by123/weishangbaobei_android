...
public class IFloatWindowImpl extends IFloatWindow {
                        ...
                        case 1:
                            ...
                            switch (IFloatWindowImpl.this.mB.mMoveType) {
                                case 3:
                                    ...
                                    ValueAnimator unused6 = IFloatWindowImpl.this.mAnimator = ObjectAnimator.ofInt(new int[]{x, (x * 2) + view.getWidth() > Util.getScreenWidth(IFloatWindowImpl.this.mB.mApplicationContext) ? (Util.getScreenWidth(IFloatWindowImpl.this.mB.mApplicationContext) - view.getWidth()) - IFloatWindowImpl.this.mB.mSlideRightMargin : IFloatWindowImpl.this.mB.mSlideLeftMargin});
    ...
    public void updateX(int i, float f) {
        checkMoveType();
        this.mB.xOffset = (int) (((float) (i == 0 ? Util.getScreenWidth(this.mB.mApplicationContext) : Util.getScreenHeight(this.mB.mApplicationContext))) * f);
    ...
    public void updateY(int i, float f) {
        checkMoveType();
        this.mB.yOffset = (int) (((float) (i == 0 ? Util.getScreenWidth(this.mB.mApplicationContext) : Util.getScreenHeight(this.mB.mApplicationContext))) * f);
