...
import com.wx.assistants.adapter.VoiceCollectionRecordAdapter;
...
public class MyVoiceCollectionFragment extends Fragment {
    private VoiceCollectionRecordAdapter adapter;
    @BindView(2131296952)
    ListView listView;
    ...
    public static MyVoiceCollectionFragment newInstance() {
        Bundle bundle = new Bundle();
        MyVoiceCollectionFragment myVoiceCollectionFragment = new MyVoiceCollectionFragment();
        myVoiceCollectionFragment.setArguments(bundle);
        return myVoiceCollectionFragment;
    }

    public void initData() {
        this.mRecords = new ArrayList();
        this.adapter = new VoiceCollectionRecordAdapter(getContext(), this.mRecords);
    ...
    public void initView() {
        this.refreshLayout.setOnRefreshListener((OnRefreshListener) new OnRefreshListener() {
            public void onRefresh(RefreshLayout refreshLayout) {
                MyVoiceCollectionFragment.this.initData();
            }
        });
    }
    ...
    public void onDestroy() {
        MyVoiceCollectionFragment.super.onDestroy();
    ...
    public void onDestroyView() {
        MyVoiceCollectionFragment.super.onDestroyView();
