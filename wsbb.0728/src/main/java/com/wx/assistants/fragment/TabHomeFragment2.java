...
public class TabHomeFragment2 extends Fragment {
    ...
    private class ImgAdapter extends PagerAdapter {
        ...
        public void destroyItem(ViewGroup viewGroup, int i, Object obj) {
            TabHomeFragment2.this.list_imgs.size();
    ...
    public void initViewData() {
        ...
        this.homeRenMaiItemBeans.add(new HomeItemBean(AutoAddMyCustomerActivity.class, 2131230992, 2131558518, "手动输入加人", "", false));
        ...
        this.homeGroupSendItemBeans.add(new HomeItemBean(GroupSendTextImageToGroupActivity.class, 2131230994, 2131558548, "图文群发", "", false));
