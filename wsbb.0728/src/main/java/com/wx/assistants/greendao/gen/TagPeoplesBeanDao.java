...
public class TagPeoplesBeanDao extends AbstractDao<TagPeoplesBean, Long> {
    ...
    public TagPeoplesBean readEntity(Cursor cursor, int i) {
        ...
        int i5 = i + 3;
        int i6 = i + 4;
        return new TagPeoplesBean(cursor.isNull(i2) ? null : Long.valueOf(cursor.getLong(i2)), cursor.isNull(i3) ? null : cursor.getString(i3), cursor.isNull(i4) ? null : cursor.getString(i4), cursor.isNull(i5) ? null : cursor.getString(i5), cursor.isNull(i6) ? null : cursor.getString(i6));
    }
