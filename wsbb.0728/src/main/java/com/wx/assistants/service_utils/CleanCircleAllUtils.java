...
public class CleanCircleAllUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
        ...
        try {
            ...
            if (rootInActiveWindow != null) {
                ...
                if (this.startIndex < findAccessibilityNodeInfosByViewId3.size()) {
                    ...
                    if (this.isCanEnd || findAccessibilityNodeInfosByViewId3.size() == 0) {
    ...
    public void executeStartIndexSnsUserUI() {
        ...
        try {
            ...
            if (findViewIdAndGetText4 != null && !"".equals(findViewIdAndGetText4)) {
                if ("今天".equals(findViewIdAndGetText4) || "今日".equals(findViewIdAndGetText4)) {
                ...
                } else if ("昨天".equals(findViewIdAndGetText4) || "昨日".equals(findViewIdAndGetText4)) {
    ...
    public void initAlbumUI() {
        ...
        new PerformClickUtils2().checkNodeStringsHasSomeOne(this.autoService, "我的朋友圈", "前往朋友圈", executeSpeed + executeSpeedSetting, 50, 600, new PerformClickUtils2.OnCheckListener() {
            public void find(int i) {
                if (i == 0) {
                    try {
    ...
    public void initSnsCommentDetailUI() {
        ...
        try {
            new PerformClickUtils2().check(this.autoService, desc_text_time_id, executeSpeed + executeSpeedSetting, 100, 300, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
                public void find(int i) {
                    List<AccessibilityNodeInfo> findAccessibilityNodeInfosByViewId;
    ...
    public void initSnsUserUIForAll() {
        if (this.isExeTasking) {
            ...
            try {
                new PerformClickUtils2().checkNodeId(this.autoService, list_circle_layout_id, executeSpeed + executeSpeedSetting, 100, 30, new PerformClickUtils2.OnCheckListener() {
                    public void find(int i) {
                        LogUtils.log("WS_BABY.SnsUserUI.1");
    ...
    public void initSnsUserUIForTime() {
        ...
        new PerformClickUtils2().checkNodeId(this.autoService, list_circle_layout_id, executeSpeed + executeSpeedSetting, 100, 100, new PerformClickUtils2.OnCheckListener() {
            public void find(int i) {
                CleanCircleAllUtils.this.executeSnsUserUI();
            }
