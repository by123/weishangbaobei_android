...
public class CleanZombieFanCollectUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
            ...
            public void find(int i) {
                ...
                new PerformClickUtils2().checkNodeIdNilExist(CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.chatting_progress_id, CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION, 200, 200, new PerformClickUtils2.OnCheckListener() {
                    ...
                    public void nuFind() {
                        ...
                        try {
                            int unused = CleanZombieFanCollectUtils.this.lastReSendNum = PerformClickUtils.findViewStringListSize(CleanZombieFanCollectUtils.this.autoService, "重发");
                            PrintStream printStream = System.out;
                            printStream.println("WS_BABY_beforeReSendNum" + CleanZombieFanCollectUtils.this.beforeReSendNum);
                            PrintStream printStream2 = System.out;
                            printStream2.println("WS_BABY_lastReSendNum" + CleanZombieFanCollectUtils.this.lastReSendNum);
                            if (CleanZombieFanCollectUtils.this.lastReSendNum > CleanZombieFanCollectUtils.this.beforeReSendNum) {
                                int unused2 = CleanZombieFanCollectUtils.this.continuityNilFriendCount = CleanZombieFanCollectUtils.this.continuityNilFriendCount + 1;
                                CleanZombieFanCollectUtils.access$908(CleanZombieFanCollectUtils.this);
                                if (CleanZombieFanCollectUtils.this.excFriendsNum < 300 || CleanZombieFanCollectUtils.this.continuityNilFriendCount < 3) {
                                    try {
                                        List<AccessibilityNodeInfo> findViewIdList = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.contact_title_id);
                                        if (findViewIdList == null || findViewIdList.size() <= 0 || !MyApplication.enforceable) {
                                            List<AccessibilityNodeInfo> findViewIdList2 = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.right_more_id);
                                            if (findViewIdList2 != null && findViewIdList2.size() > 0 && MyApplication.enforceable) {
                                                ...
                                                CleanZombieFanCollectUtils.this.initFirstSingleChatInfoUI();
                                            }
                                        } else {
                                            try {
                                            ...
                                            if (str != null) {
                                                if (str.startsWith("A000非好友_") && MyApplication.enforceable) {
                                                    if (CleanZombieFanCollectUtils.this.isCanDelete) {
                                                        List<AccessibilityNodeInfo> findViewIdList3 = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.right_more_id);
                                                    ...
                                                    } else if (CleanZombieFanCollectUtils.this.remarkLabel == null || "".equals(CleanZombieFanCollectUtils.this.remarkLabel)) {
                                                        ...
                                                        List<AccessibilityNodeInfo> findViewIdList4 = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.right_more_id);
                                            ...
                                            List<AccessibilityNodeInfo> findViewIdList5 = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.right_more_id);
                                        ...
                                        List<AccessibilityNodeInfo> findViewIdList6 = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.right_more_id);
                                    ...
                                    String unused3 = CleanZombieFanCollectUtils.this.sendResult = "由于您连续检测了300个以上的好友，由于微信限制规则，检测到了连续三条非好友，为了防止检测异常（检测错误），希望您隔3小时后，继续检测。";
                                    BaseServiceUtils.removeEndView(CleanZombieFanCollectUtils.this.mMyManager);
                                }
                            } else {
                                int unused4 = CleanZombieFanCollectUtils.this.continuityNilFriendCount = 0;
                            ...
                            myWindowManager = CleanZombieFanCollectUtils.this.mMyManager;
                            ...
                            MyWindowManager myWindowManager2 = CleanZombieFanCollectUtils.this.mMyManager;
                            BaseServiceUtils.updateBottomText(myWindowManager2, "从第 " + CleanZombieFanCollectUtils.this.startInt + " 个好友，开始检测僵尸粉\n已执行 " + CleanZombieFanCollectUtils.this.excFriendsNum + " 人 ,非好友 " + CleanZombieFanCollectUtils.this.noFriendsNum + " 人");
                            throw th;
                        }
                        sb.append("从第 ");
                        sb.append(CleanZombieFanCollectUtils.this.startInt);
                        sb.append(" 个好友，开始检测僵尸粉\n已执行 ");
                        sb.append(CleanZombieFanCollectUtils.this.excFriendsNum);
                        sb.append(" 人 ,非好友 ");
                        sb.append(CleanZombieFanCollectUtils.this.noFriendsNum);
                        sb.append(" 人");
    ...
    public void initExMore() {
        ...
        new PerformClickUtils2().check(this.autoService, right_more_id, executeSpeed + 350 + executeSpeedSetting, 100, 100, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
            public void find(int i) {
                        ...
                        if (findAccessibilityNodeInfosByViewId.get(0) != null && "android.widget.ListView".equals(findAccessibilityNodeInfosByViewId.get(0).getClassName())) {
                            ...
                            if (findAccessibilityNodeInfosByViewId.get(0).getChildCount() > 0 && MyApplication.enforceable) {
                                ...
                                if (!z) {
                                    ...
                                    List<AccessibilityNodeInfo> findViewIdList = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.collection_list_id);
                                ...
                                new PerformClickUtils2().checkNodeId(CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.dialog_ok_id, BaseServiceUtils.executeSpeed + BaseServiceUtils.executeSpeedSetting, 100, 600, new PerformClickUtils2.OnCheckListener() {
                                    public void find(int i) {
                                        if (CleanZombieFanCollectUtils.this.sayContent != null && !"".equals(CleanZombieFanCollectUtils.this.sayContent)) {
                                            CleanZombieFanCollectUtils.this.sleep(10);
                                            AutoService autoService = CleanZombieFanCollectUtils.this.autoService;
                                            String str = BaseServiceUtils.toast_edit_id;
                                            PerformClickUtils.findViewByIdAndPasteContent(autoService, str, BaseServiceUtils.remarkName + "" + CleanZombieFanCollectUtils.this.sayContent);
                                        }
                                        List<AccessibilityNodeInfo> findViewIdList = PerformClickUtils.findViewIdList((AccessibilityService) CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.dialog_ok_id);
                                        if (findViewIdList != null && findViewIdList.size() > 0 && MyApplication.enforceable) {
                                            findViewIdList.get(0).performAction(16);
                                            new PerformClickUtils2().checkNodeId(CleanZombieFanCollectUtils.this.autoService, BaseServiceUtils.voice_left_id, 1500, 100, 600, new PerformClickUtils2.OnCheckListener() {
                                                public void find(int i) {
                                                    boolean unused = CleanZombieFanCollectUtils.this.isFirstFav = false;
                                                    CleanZombieFanCollectUtils.this.initChattingBackUI();
                                                }
