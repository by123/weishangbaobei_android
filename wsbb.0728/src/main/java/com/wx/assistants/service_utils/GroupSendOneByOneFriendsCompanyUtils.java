...
public class GroupSendOneByOneFriendsCompanyUtils extends BaseServiceCompanyUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
                        ...
                        new Thread(new Runnable() {
                            public void run() {
                                try {
                                    ...
                                    for (int access$000 = GroupSendOneByOneFriendsCompanyUtils.this.picCount - 1; access$000 > -1 && MyApplication.enforceable; access$000--) {
    ...
    public void inputText(String str) {
        ...
        try {
            ...
            if (rootInActiveWindow != null && (findFocus = rootInActiveWindow.findFocus(1)) != null) {
                ...
                ((ClipboardManager) this.autoService.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", str + str2));
                if (Build.VERSION.SDK_INT >= 18) {
                    Bundle bundle2 = new Bundle();
                    bundle2.putInt("ACTION_ARGUMENT_SELECTION_START_INT", 0);
                    bundle2.putInt("ACTION_ARGUMENT_SELECTION_END_INT", (str + str2).length());
    ...
    public void jumpFirstChattingUI(int i) {
        ...
        new PerformClickUtils2().checkNodeId(this.autoService, company_voice_left_id, executeSpeedSetting + i, 100, 100, new PerformClickUtils2.OnCheckListener() {
            public void find(int i) {
