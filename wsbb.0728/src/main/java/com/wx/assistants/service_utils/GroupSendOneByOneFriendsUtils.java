...
public class GroupSendOneByOneFriendsUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
                    ...
                    new Thread(new Runnable() {
                        public void run() {
                            try {
                                ...
                                for (int access$000 = GroupSendOneByOneFriendsUtils.this.picCount - 1; access$000 > -1 && MyApplication.enforceable; access$000--) {
    ...
    public void jumpFirstChattingUI(int i) {
        ...
        new PerformClickUtils2().checkNodeId(this.autoService, voice_left_id, executeSpeedSetting + i, 100, 100, new PerformClickUtils2.OnCheckListener() {
            public void find(int i) {
