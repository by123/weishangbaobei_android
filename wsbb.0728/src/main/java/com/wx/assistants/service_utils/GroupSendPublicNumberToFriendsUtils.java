            ...
            if (this.isCanExecuteSelect && MyApplication.enforceable) {
                ...
                new PerformClickUtils2().checkNodeAllIds(this.autoService, list_select_name_id, list_select_checkbox, executeSpeed + executeSpeedSetting, 100, 300, new PerformClickUtils2.OnCheckListener() {
                    public void find(int i) {
                        new Thread(new Runnable() {
                            /* JADX WARNING: CFG modification limit reached, blocks count: 210 */
                            public void run() {
                                int i;
                                ...
                                if (rootInActiveWindow != null) {
                                    ...
                                    while (true) {
                                        boolean z3 = z2;
                                        i = 0;
                                        while (z3 && GroupSendPublicNumberToFriendsUtils.this.pullRecordNum > 1 && MyApplication.enforceable) {
                                            ...
                                            if (!(findAccessibilityNodeInfosByViewId == null || findAccessibilityNodeInfosByViewId.size() <= 0 || (accessibilityNodeInfo = findAccessibilityNodeInfosByViewId.get(0)) == null)) {
                                                ...
                                                if (findAccessibilityNodeInfosByViewId2 == null || findAccessibilityNodeInfosByViewId2.size() <= 0) {
                                                    ...
                                                    int i2 = 0;
                                                    while (true) {
                                                        if (i2 < findAccessibilityNodeInfosByViewId2.size() - 1) {
                                    ...
                                    while (true) {
                                        ...
                                        if (findAccessibilityNodeInfosByViewId3 == null || findAccessibilityNodeInfosByViewId3.size() <= 0) {
                                            ...
                                            while (true) {
                                                int i4 = i3;
                                                if (i4 < findAccessibilityNodeInfosByViewId3.size() - 1) {
                                                    if (!MyApplication.enforceable) {
                                                        LogUtils.log("WS_BABY_SelectContactUI_1111111111111111111111111@");
                                                        break loop3;
                                                    }
                                                    AccessibilityNodeInfo accessibilityNodeInfo3 = findAccessibilityNodeInfosByViewId3.get(i4);
                                    ...
                                    sb.append("正在分批群发 ");
                                    sb.append(GroupSendPublicNumberToFriendsUtils.this.otherSendTypeName);
                                    sb.append("\n已向 ");
        ...
        try {
            ...
            new PerformClickUtils2().delay(100, new PerformClickUtils2.OnCheckListener() {
                public void find(int i) {
                    ...
                    new PerformClickUtils2().check(GroupSendPublicNumberToFriendsUtils.this.autoService, BaseServiceUtils.right_more_id, BaseServiceUtils.executeSpeed + BaseServiceUtils.executeSpeedSetting, 100, 600, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
                        public void find(int i) {
                                                ...
                                                while (z && i < findAccessibilityNodeInfosByViewId.size() && MyApplication.enforceable) {
                                                    ...
                                                    if (accessibilityNodeInfo != null && MyApplication.enforceable) {
                                                        ...
                                                        if (str.trim().equals(str.trim())) {
                                                            ...
                                                            if (GroupSendPublicNumberToFriendsUtils.this.recordNum == GroupSendPublicNumberToFriendsUtils.this.maxNum || GroupSendPublicNumberToFriendsUtils.this.tagListPeoples.size() == 0) {
                                                                if (GroupSendPublicNumberToFriendsUtils.this.tagListPeoples.size() == 0) {
                                                                    boolean unused2 = GroupSendPublicNumberToFriendsUtils.this.isFilled = true;
                                                                }
                                                                GroupSendPublicNumberToFriendsUtils.this.searchEnd();
                                                            } else {
                                                                GroupSendPublicNumberToFriendsUtils.this.initSelectNickName();
