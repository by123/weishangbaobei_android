        ...
        try {
            ...
            new PerformClickUtils2().checkFavListNodeId(this.autoService, collection_list_id, this.isFirstFav ? SocializeConstants.CANCLE_RESULTCODE : executeSpeed + (executeSpeedSetting / 2), 100, 600, new PerformClickUtils2.OnCheckListener() {
                ...
                public void find(int i) {
                    ...
                    AccessibilityNodeInfo rootInActiveWindow = GroupSendVoiceToGroupUtils.this.autoService.getRootInActiveWindow();
                            ...
                            if (findAccessibilityNodeInfosByViewId.get(0) != null && "android.widget.ListView".equals(findAccessibilityNodeInfosByViewId.get(0).getClassName())) {
                                ...
                                if (findAccessibilityNodeInfosByViewId.get(0).getChildCount() > 0 && MyApplication.enforceable) {
                                    ...
                                    if (!z) {
                                        ...
                                        List<AccessibilityNodeInfo> findViewIdList = PerformClickUtils.findViewIdList((AccessibilityService) GroupSendVoiceToGroupUtils.this.autoService, BaseServiceUtils.collection_list_id);
                                    ...
                                    new PerformClickUtils2().checkNodeId(GroupSendVoiceToGroupUtils.this.autoService, BaseServiceUtils.dialog_ok_id, 80, 50, 100, new PerformClickUtils2.OnCheckListener() {
                                        public void find(int i) {
                                            try {
                                                GroupSendVoiceToGroupUtils.this.sleep(10);
                                                PerformClickUtils.inputText(GroupSendVoiceToGroupUtils.this.autoService, GroupSendVoiceToGroupUtils.this.sayContent);
                                            } catch (Exception e) {
                                                LogUtils.log("WS_BABY_FavSelectUI.into9");
                                            }
                                            GroupSendVoiceToGroupUtils.this.sleep(10);
                                            List<AccessibilityNodeInfo> findViewIdList = PerformClickUtils.findViewIdList((AccessibilityService) GroupSendVoiceToGroupUtils.this.autoService, BaseServiceUtils.dialog_ok_id);
                                            if (findViewIdList != null && findViewIdList.size() > 0 && MyApplication.enforceable) {
                                                LogUtils.log("WS_BABY_FavSelectUI.into11");
                                                findViewIdList.get(0).performAction(16);
                                                if (GroupSendVoiceToGroupUtils.this.circulateInnerSize == 1 && MyApplication.enforceable) {
                                                    GroupSendVoiceToGroupUtils.access$508(GroupSendVoiceToGroupUtils.this);
                                                    GroupSendVoiceToGroupUtils.access$008(GroupSendVoiceToGroupUtils.this);
                                                    GroupSendVoiceToGroupUtils.this.saveRecord(GroupSendVoiceToGroupUtils.this.startIndexFromUser == 1 ? GroupSendVoiceToGroupUtils.this.sendGroupNum + 1 + GroupSendVoiceToGroupUtils.this.jumpNum : GroupSendVoiceToGroupUtils.this.sendGroupNum + GroupSendVoiceToGroupUtils.this.startIndexFromUser + GroupSendVoiceToGroupUtils.this.jumpNum);
                                                    GroupSendVoiceToGroupUtils.this.updateBottom(0);
                                                }
                                                new PerformClickUtils2().checkNodeId(GroupSendVoiceToGroupUtils.this.autoService, BaseServiceUtils.voice_left_id, BaseServiceUtils.executeSpeed + BaseServiceUtils.executeSpeedSetting, 100, 600, new PerformClickUtils2.OnCheckListener() {
                                                    public void find(int i) {
                                                        boolean unused = GroupSendVoiceToGroupUtils.this.isFirstFav = false;
                                                        GroupSendVoiceToGroupUtils.this.initBackChattingUI();
                                                    }
