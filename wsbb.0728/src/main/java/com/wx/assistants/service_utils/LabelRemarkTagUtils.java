...
public class LabelRemarkTagUtils extends BaseServiceUtils implements MyWindowManager.MiddleViewListener, MyWindowManager.EndViewListener {
                ...
                if (LabelRemarkTagUtils.this.remarkNickName != null && !"".equals(LabelRemarkTagUtils.this.remarkNickName)) {
                    new PerformClickUtils2().check(LabelRemarkTagUtils.this.autoService, BaseServiceUtils.right_more_id, 50, 100, 10, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
                        public void find(int i) {
                            ...
                            new PerformClickUtils2().checkNodeStringsHasSomeOne(LabelRemarkTagUtils.this.autoService, "设置备注和标签", "设置备注及标签", BaseServiceUtils.executeSpeed + (BaseServiceUtils.executeSpeedSetting / 8), 100, 10, new PerformClickUtils2.OnCheckListener() {
                                public void find(int i) {
    ...
    public void initContactLabelEditUI() {
        ...
        try {
            ...
            PerformClickUtils2 performClickUtils2 = new PerformClickUtils2();
            AutoService autoService = this.autoService;
            String str = single_contact_nick_name_id;
            if (!this.isJumpExecute) {
                i = CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION;
            }
            performClickUtils2.check(autoService, str, i, 100, 100, (PerformClickUtils2.OnCheckListener) new PerformClickUtils2.OnCheckListener() {
                public void find(int i) {
    ...
    public void initContactLabelManagerUI() {
        ...
        try {
            ...
            new PerformClickUtils2().checkNodeAllIds(this.autoService, tag_list_item_num_id, tag_list_item_name_id, executeSpeed + executeSpeedSetting, 100, 300, new PerformClickUtils2.OnCheckListener() {
                public void find(int i) {
                    String str;
                            ...
                            if (findViewIdList2 != null && !findViewIdList2.isEmpty() && MyApplication.enforceable) {
                                if (LabelRemarkTagUtils.this.startIndex < findViewIdList2.size() && MyApplication.enforceable) {
                                    ...
                                    if (!LabelRemarkTagUtils.this.deleteTags.contains(LabelRemarkTagUtils.this.nowTag)) {
                                        ...
                                        int unused3 = LabelRemarkTagUtils.this.startIndex = 0;
                                        String unused4 = LabelRemarkTagUtils.this.lastTagName = "";
                                        LabelRemarkTagUtils.this.initContactLabelEditUI();
                                        return;
                                    } else {
                                    ...
                                    if (findViewIdList != null && findViewIdList.size() > 0 && MyApplication.enforceable) {
                                        ...
                                        if (findViewIdList4 != null && findViewIdList4.size() > 0 && MyApplication.enforceable) {
                                            ...
                                            if (str.equals(LabelRemarkTagUtils.this.lastTagName)) {
                                                boolean unused5 = LabelRemarkTagUtils.this.isWhile = false;
                                                BaseServiceUtils.removeEndView(LabelRemarkTagUtils.this.mMyManager);
                                            } else {
                                                String unused6 = LabelRemarkTagUtils.this.lastTagName = str;
                                            }
                                            int unused7 = LabelRemarkTagUtils.this.startIndex = 0;
                                        }
                                    }
                                }
                            }
