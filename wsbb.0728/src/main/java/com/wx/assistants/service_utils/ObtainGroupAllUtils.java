                                ...
                                if (accessibilityNodeInfo != null) {
                                    ...
                                    if (rootInActiveWindow != null && MyApplication.enforceable) {
                                        ...
                                        if (findAccessibilityNodeInfosByViewId != null && findAccessibilityNodeInfosByViewId.size() > 0 && MyApplication.enforceable) {
                                            ...
                                            String unused3 = ObtainGroupAllUtils.this.wxName = str;
                                            String unused4 = ObtainGroupAllUtils.this.wxNumber = str2;
                                        ...
                                        str = "";
                                        String unused5 = ObtainGroupAllUtils.this.wxName = str;
                                        String unused6 = ObtainGroupAllUtils.this.wxNumber = str2;
