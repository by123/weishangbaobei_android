                        ...
                        public void find(int i) {
                            ...
                            if (findViewIdList == null || findViewIdList.size() <= 0 || !MyApplication.enforceable) {
                                ...
                                if (accessibilityNodeInfo2 != null) {
                                    ...
                                    String unused3 = ObtainTagUtils.this.wxName = str;
                                    String unused4 = ObtainTagUtils.this.wxNumber = str2;
                                    TagBean tagBean2 = new TagBean();
                                    tagBean2.setWxName(str);
                                    tagBean2.setWxNum(str2);
                                    SQLiteUtils.getInstance().addTagBean(tagBean2);
                                    SPUtils.put(ObtainTagUtils.this.autoService, "wx_user", str + "#" + str2);
                                }
                            }
            ...
            if (MyApplication.enforceable) {
                ...
                if (this.startIndex < this.scrollTags.size() && MyApplication.enforceable) {
                    ...
                    if (accessibilityNodeInfo2 != null) {
                        ...
                        if (this.tagList.contains(str) || "(0)".equals(this.lastNameNum)) {
