            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    if (MyApplication.enforceable) {
                        ...
                        boolean findNodeIsExistByText = PerformClickUtils.findNodeIsExistByText(OneKeyForwardBigVideoUtils.this.autoService, "返回");
                        boolean findNodeIsExistByText2 = PerformClickUtils.findNodeIsExistByText(OneKeyForwardBigVideoUtils.this.autoService, "拍照分享");
                        boolean findNodeIsExistByText3 = PerformClickUtils.findNodeIsExistByText(OneKeyForwardBigVideoUtils.this.autoService, "通讯录");
                        boolean findNodeIsExistByText4 = PerformClickUtils.findNodeIsExistByText(OneKeyForwardBigVideoUtils.this.autoService, "发现");
                        boolean findNodeIsExistById = PerformClickUtils.findNodeIsExistById((AccessibilityService) OneKeyForwardBigVideoUtils.this.autoService, BaseServiceUtils.home_tab_layout_id);
