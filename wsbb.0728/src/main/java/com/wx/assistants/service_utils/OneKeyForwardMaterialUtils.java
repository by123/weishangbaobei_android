            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    if (MyApplication.enforceable) {
                        ...
                        boolean findNodeIsExistByText = PerformClickUtils.findNodeIsExistByText(OneKeyForwardMaterialUtils.this.autoService, "返回");
                        boolean findNodeIsExistByText2 = PerformClickUtils.findNodeIsExistByText(OneKeyForwardMaterialUtils.this.autoService, "拍照分享");
                        boolean findNodeIsExistByText3 = PerformClickUtils.findNodeIsExistByText(OneKeyForwardMaterialUtils.this.autoService, "通讯录");
                        boolean findNodeIsExistByText4 = PerformClickUtils.findNodeIsExistByText(OneKeyForwardMaterialUtils.this.autoService, "发现");
                        boolean findNodeIsExistById = PerformClickUtils.findNodeIsExistById((AccessibilityService) OneKeyForwardMaterialUtils.this.autoService, BaseServiceUtils.home_tab_layout_id);
                        ...
                        } else if (!Boolean.valueOf(findNodeIsExistByText3).booleanValue() || !Boolean.valueOf(findNodeIsExistByText4).booleanValue() || !Boolean.valueOf(findNodeIsExistById).booleanValue()) {
            ...
            public void find(int i) {
                ...
                try {
                    ...
                    if (findViewIdList != null && findViewIdList.size() > 0) {
                        int access$000 = OneKeyForwardMaterialUtils.this.num - 1;
                        while (true) {
                            int i2 = access$000;
