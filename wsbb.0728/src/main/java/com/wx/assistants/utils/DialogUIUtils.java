...
public class DialogUIUtils {
    ...
    public static void dialogAppVersion(Context context, int i, String str, String str2, View.OnClickListener onClickListener, View.OnClickListener onClickListener2) {
        ...
        if (!VersionUpdateDialog.isShowing) {
            ...
            VersionUpdateDialogNew1 versionPositiveButton = builder.setTitle("V:" + str).setMsg(str2).setVersionNegativeButton("下次再说", (VersionUpdateDialogNew1.TitleColor) null, onClickListener).setVersionPositiveButton("立即更新", 1, (VersionUpdateDialogNew1.TitleColor) null, onClickListener2);
            if (i != 0) {
                z = false;
            }
    ...
    public static void dialogNoPermission(Context context, String str, View.OnClickListener onClickListener, View.OnClickListener onClickListener2) {
        ...
        if (TextUtils.equals("android.permission.CAMERA", str)) {
            format = String.format(context.getResources().getString(2131689866), new Object[]{context.getResources().getString(2131689863)});
        } else if (TextUtils.equals("android.permission.RECORD_AUDIO", str)) {
            format = String.format(context.getResources().getString(2131689866), new Object[]{context.getResources().getString(2131689867)});
        } else if (TextUtils.equals("android.permission.READ_CONTACTS", str)) {
            format = String.format(context.getResources().getString(2131689866), new Object[]{context.getResources().getString(2131689864)});
