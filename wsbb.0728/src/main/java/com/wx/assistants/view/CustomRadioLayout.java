...
public class CustomRadioLayout extends LinearLayout {
    ...
    public CustomRadioLayout(Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mContext = context;
        initCirculateNumView(context);
    }

    public CustomRadioLayout(Context context, @Nullable AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.mContext = context;
    }

    public void initCirculateNumView(Context context) {
        LayoutInflater.from(context).inflate(2131427742, this, true);
    }
                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        if (CustomRadioLayout.this.listener != null) {
                            CustomRadioLayout.this.listener.mode(0);
                            return;
                        }
                        return;
                    case 2131296497:
                        if (CustomRadioLayout.this.listener != null) {
                            CustomRadioLayout.this.listener.mode(1);
                            return;
                        }
                        return;
                    default:
