                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused2 = FriendLikeCommentLayout.this.startIndexAll = 1;
                        }
                        FriendLikeCommentLayout.this.start_pull.setText("从第" + FriendLikeCommentLayout.this.startIndexAll + "个微信好友开始");
                        FontUtils.changeFontColor(FriendLikeCommentLayout.this.mContext, FriendLikeCommentLayout.this.start_pull);
                        String unused3 = FriendLikeCommentLayout.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyAllLabel, "");
                        ...
                        String unused4 = FriendLikeCommentLayout.this.friendsTags = FriendLikeCommentLayout.this.allLabel;
                        if (FriendLikeCommentLayout.this.listener != null) {
                            int unused5 = FriendLikeCommentLayout.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused6 = FriendLikeCommentLayout.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyPart, 1)).intValue();
                        } catch (Exception e2) {
                            int unused7 = FriendLikeCommentLayout.this.startIndexPart = 1;
                        }
                        FriendLikeCommentLayout.this.start_pull.setText("从第" + FriendLikeCommentLayout.this.startIndexPart + "个微信好友开始");
                        FontUtils.changeFontColor(FriendLikeCommentLayout.this.mContext, FriendLikeCommentLayout.this.start_pull);
                        String unused8 = FriendLikeCommentLayout.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyPartLabel, "");
                        ...
                        String unused9 = FriendLikeCommentLayout.this.friendsTags = FriendLikeCommentLayout.this.partLabel;
                        if (FriendLikeCommentLayout.this.listener != null) {
                            int unused10 = FriendLikeCommentLayout.this.sendTypeMode = 1;
                            FriendLikeCommentLayout.this.listener.sendType(FriendLikeCommentLayout.this.sendTypeMode);
                            FriendLikeCommentLayout.this.listener.sendStartIndex(FriendLikeCommentLayout.this.startIndexPart);
                        }
                        String unused11 = FriendLikeCommentLayout.this.partLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyPartLabelMember, "");
                    ...
                    case 2131296498:
                        ...
                        FriendLikeCommentLayout.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused12 = FriendLikeCommentLayout.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyShield, 1)).intValue();
                        } catch (Exception e3) {
                            int unused13 = FriendLikeCommentLayout.this.startIndexShield = 1;
                        }
                        FriendLikeCommentLayout.this.start_pull.setText("从第" + FriendLikeCommentLayout.this.startIndexShield + "个微信好友开始");
                        FontUtils.changeFontColor(FriendLikeCommentLayout.this.mContext, FriendLikeCommentLayout.this.start_pull);
                        String unused14 = FriendLikeCommentLayout.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyShieldLabel, "");
                        ...
                        String unused15 = FriendLikeCommentLayout.this.friendsTags = FriendLikeCommentLayout.this.shieldLabel;
                        if (FriendLikeCommentLayout.this.listener != null) {
                            int unused16 = FriendLikeCommentLayout.this.sendTypeMode = 2;
                            FriendLikeCommentLayout.this.listener.sendStartIndex(FriendLikeCommentLayout.this.startIndexShield);
                            FriendLikeCommentLayout.this.listener.sendType(FriendLikeCommentLayout.this.sendTypeMode);
                        }
                        String unused17 = FriendLikeCommentLayout.this.shieldLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendLikeCommentLayout.this.keyShieldLabelMember, "");
