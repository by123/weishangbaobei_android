                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused2 = FriendSendModeLayout.this.startIndexAll = 1;
                        }
                        FriendSendModeLayout.this.start_pull.setText("从第" + FriendSendModeLayout.this.startIndexAll + "个微信好友开始");
                        FontUtils.changeFontColor(FriendSendModeLayout.this.mContext, FriendSendModeLayout.this.start_pull);
                        String unused3 = FriendSendModeLayout.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyAllLabel, "");
                        ...
                        String unused4 = FriendSendModeLayout.this.friendsTags = FriendSendModeLayout.this.allLabel;
                        if (FriendSendModeLayout.this.listener != null) {
                            int unused5 = FriendSendModeLayout.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused6 = FriendSendModeLayout.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyPart, 1)).intValue();
                        } catch (Exception e2) {
                            int unused7 = FriendSendModeLayout.this.startIndexPart = 1;
                        }
                        FriendSendModeLayout.this.start_pull.setText("从第" + FriendSendModeLayout.this.startIndexPart + "个微信好友开始");
                        FontUtils.changeFontColor(FriendSendModeLayout.this.mContext, FriendSendModeLayout.this.start_pull);
                        String unused8 = FriendSendModeLayout.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyPartLabel, "");
                        ...
                        String unused9 = FriendSendModeLayout.this.friendsTags = FriendSendModeLayout.this.partLabel;
                        if (FriendSendModeLayout.this.listener != null) {
                            int unused10 = FriendSendModeLayout.this.sendTypeMode = 1;
                            FriendSendModeLayout.this.listener.sendType(FriendSendModeLayout.this.sendTypeMode);
                            FriendSendModeLayout.this.listener.sendStartIndex(FriendSendModeLayout.this.startIndexPart);
                        }
                        String unused11 = FriendSendModeLayout.this.partLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyPartLabelMember, "");
                    ...
                    case 2131296498:
                        ...
                        FriendSendModeLayout.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused12 = FriendSendModeLayout.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyShield, 1)).intValue();
                        } catch (Exception e3) {
                            int unused13 = FriendSendModeLayout.this.startIndexShield = 1;
                        }
                        FriendSendModeLayout.this.start_pull.setText("从第" + FriendSendModeLayout.this.startIndexShield + "个微信好友开始");
                        FontUtils.changeFontColor(FriendSendModeLayout.this.mContext, FriendSendModeLayout.this.start_pull);
                        String unused14 = FriendSendModeLayout.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyShieldLabel, "");
                        ...
                        String unused15 = FriendSendModeLayout.this.friendsTags = FriendSendModeLayout.this.shieldLabel;
                        if (FriendSendModeLayout.this.listener != null) {
                            int unused16 = FriendSendModeLayout.this.sendTypeMode = 2;
                            FriendSendModeLayout.this.listener.sendStartIndex(FriendSendModeLayout.this.startIndexShield);
                            FriendSendModeLayout.this.listener.sendType(FriendSendModeLayout.this.sendTypeMode);
                        }
                        String unused17 = FriendSendModeLayout.this.shieldLabelMember = (String) SPUtils.get(MyApplication.getConText(), FriendSendModeLayout.this.keyShieldLabelMember, "");
