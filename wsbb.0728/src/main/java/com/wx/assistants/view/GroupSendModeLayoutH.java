                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case 2131296496:
                        ...
                        try {
                            ...
                            int unused2 = GroupSendModeLayoutH.this.startIndexAll = 1;
                        }
                        TextView access$000 = GroupSendModeLayoutH.this.start_pull;
                        access$000.setText("从第" + GroupSendModeLayoutH.this.startIndexAll + "个微信群开始");
                        FontUtils.changeFontColor(GroupSendModeLayoutH.this.mContext, GroupSendModeLayoutH.this.start_pull);
                        String unused3 = GroupSendModeLayoutH.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH.this.keyAllLabel, "");
                        ...
                        String unused4 = GroupSendModeLayoutH.this.groupsTags = GroupSendModeLayoutH.this.allLabel;
                        if (GroupSendModeLayoutH.this.listener != null) {
                            int unused5 = GroupSendModeLayoutH.this.sendTypeMode = 0;
                    ...
                    case 2131296497:
                        ...
                        try {
                            int unused6 = GroupSendModeLayoutH.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH.this.keyPart, 1)).intValue();
                        } catch (Exception e2) {
                            int unused7 = GroupSendModeLayoutH.this.startIndexPart = 1;
                        }
                        ...
                        FontUtils.changeFontColor(GroupSendModeLayoutH.this.mContext, GroupSendModeLayoutH.this.start_pull);
                        String unused8 = GroupSendModeLayoutH.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH.this.keyPartLabel, "");
                        ...
                        String unused9 = GroupSendModeLayoutH.this.groupsTags = GroupSendModeLayoutH.this.partLabel;
                        if (GroupSendModeLayoutH.this.listener != null) {
                            int unused10 = GroupSendModeLayoutH.this.sendTypeMode = 1;
                            GroupSendModeLayoutH.this.listener.sendType(GroupSendModeLayoutH.this.sendTypeMode);
                    ...
                    case 2131296498:
                        ...
                        GroupSendModeLayoutH.this.jump_label_layout.setVisibility(0);
                        try {
                            int unused11 = GroupSendModeLayoutH.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH.this.keyShield, 1)).intValue();
                        } catch (Exception e3) {
                            int unused12 = GroupSendModeLayoutH.this.startIndexShield = 1;
                        }
                        ...
                        FontUtils.changeFontColor(GroupSendModeLayoutH.this.mContext, GroupSendModeLayoutH.this.start_pull);
                        String unused13 = GroupSendModeLayoutH.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), GroupSendModeLayoutH.this.keyShieldLabel, "");
                        ...
                        String unused14 = GroupSendModeLayoutH.this.groupsTags = GroupSendModeLayoutH.this.shieldLabel;
                        if (GroupSendModeLayoutH.this.listener != null) {
                            int unused15 = GroupSendModeLayoutH.this.sendTypeMode = 2;
