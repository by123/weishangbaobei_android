            ...
            public void itemClick(int i) {
                if (i == 0) {
                    ...
                    try {
                        ...
                        int unused2 = LabelRemarkSelectLayout.this.startIndexAll = 1;
                    }
                    LabelRemarkSelectLayout.this.start_pull.setText("从第" + LabelRemarkSelectLayout.this.startIndexAll + "个好友开始");
                    FontUtils.changeFontColor(LabelRemarkSelectLayout.this.mContext, LabelRemarkSelectLayout.this.start_pull);
                    String unused3 = LabelRemarkSelectLayout.this.allLabel = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyAllLabel, "");
                    ...
                    String unused4 = LabelRemarkSelectLayout.this.friendsTags = LabelRemarkSelectLayout.this.allLabel;
                    if (LabelRemarkSelectLayout.this.listener != null) {
                        int unused5 = LabelRemarkSelectLayout.this.sendTypeMode = 0;
                    ...
                    LabelRemarkSelectLayout.this.jump_label_layout.setVisibility(8);
                    try {
                        int unused6 = LabelRemarkSelectLayout.this.startIndexUnLabel = ((Integer) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyUnLabel, 1)).intValue();
                    } catch (Exception e2) {
                        int unused7 = LabelRemarkSelectLayout.this.startIndexUnLabel = 1;
                    }
                    LabelRemarkSelectLayout.this.start_pull.setText("从第" + LabelRemarkSelectLayout.this.startIndexUnLabel + "个好友开始");
                    FontUtils.changeFontColor(LabelRemarkSelectLayout.this.mContext, LabelRemarkSelectLayout.this.start_pull);
                    String unused8 = LabelRemarkSelectLayout.this.unLabelLabel = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyUnLabelLabel, "");
                    ...
                    String unused9 = LabelRemarkSelectLayout.this.friendsTags = LabelRemarkSelectLayout.this.unLabelLabel;
                    if (LabelRemarkSelectLayout.this.listener != null) {
                        int unused10 = LabelRemarkSelectLayout.this.sendTypeMode = 1;
                        LabelRemarkSelectLayout.this.listener.sendType(LabelRemarkSelectLayout.this.sendTypeMode);
                    ...
                    LabelRemarkSelectLayout.this.jump_label_layout.setVisibility(8);
                    try {
                        int unused11 = LabelRemarkSelectLayout.this.startIndexUnRemark = ((Integer) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyUnRemark, 1)).intValue();
                    } catch (Exception e3) {
                        int unused12 = LabelRemarkSelectLayout.this.startIndexUnRemark = 1;
                    }
                    LabelRemarkSelectLayout.this.start_pull.setText("从第" + LabelRemarkSelectLayout.this.startIndexUnRemark + "个好友开始");
                    FontUtils.changeFontColor(LabelRemarkSelectLayout.this.mContext, LabelRemarkSelectLayout.this.start_pull);
                    String unused13 = LabelRemarkSelectLayout.this.unRemarkLabel = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyUnRemarkLabel, "");
                    ...
                    String unused14 = LabelRemarkSelectLayout.this.friendsTags = LabelRemarkSelectLayout.this.unRemarkLabel;
                    if (LabelRemarkSelectLayout.this.listener != null) {
                        int unused15 = LabelRemarkSelectLayout.this.sendTypeMode = 2;
                        LabelRemarkSelectLayout.this.listener.sendType(LabelRemarkSelectLayout.this.sendTypeMode);
                    ...
                    try {
                        int unused16 = LabelRemarkSelectLayout.this.startIndexPart = ((Integer) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyPart, 1)).intValue();
                    } catch (Exception e4) {
                        int unused17 = LabelRemarkSelectLayout.this.startIndexPart = 1;
                    }
                    LabelRemarkSelectLayout.this.start_pull.setText("从第" + LabelRemarkSelectLayout.this.startIndexPart + "个好友开始");
                    FontUtils.changeFontColor(LabelRemarkSelectLayout.this.mContext, LabelRemarkSelectLayout.this.start_pull);
                    String unused18 = LabelRemarkSelectLayout.this.partLabel = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyPartLabel, "");
                    ...
                    String unused19 = LabelRemarkSelectLayout.this.friendsTags = LabelRemarkSelectLayout.this.partLabel;
                    if (LabelRemarkSelectLayout.this.listener != null) {
                        int unused20 = LabelRemarkSelectLayout.this.sendTypeMode = 3;
                        LabelRemarkSelectLayout.this.listener.sendType(LabelRemarkSelectLayout.this.sendTypeMode);
                    ...
                    String unused21 = LabelRemarkSelectLayout.this.partLabelMember = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyPartLabelMember, "");
                    ...
                    LabelRemarkSelectLayout.this.jump_label_layout.setVisibility(0);
                    try {
                        int unused22 = LabelRemarkSelectLayout.this.startIndexShield = ((Integer) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyShield, 1)).intValue();
                    } catch (Exception e5) {
                        int unused23 = LabelRemarkSelectLayout.this.startIndexShield = 1;
                    }
                    LabelRemarkSelectLayout.this.start_pull.setText("从第" + LabelRemarkSelectLayout.this.startIndexShield + "个好友开始");
                    FontUtils.changeFontColor(LabelRemarkSelectLayout.this.mContext, LabelRemarkSelectLayout.this.start_pull);
                    String unused24 = LabelRemarkSelectLayout.this.shieldLabel = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyShieldLabel, "");
                    ...
                    String unused25 = LabelRemarkSelectLayout.this.friendsTags = LabelRemarkSelectLayout.this.shieldLabel;
                    if (LabelRemarkSelectLayout.this.listener != null) {
                        int unused26 = LabelRemarkSelectLayout.this.sendTypeMode = 4;
                    ...
                    String unused27 = LabelRemarkSelectLayout.this.shieldLabelMember = (String) SPUtils.get(MyApplication.getConText(), LabelRemarkSelectLayout.this.keyShieldLabelMember, "");
