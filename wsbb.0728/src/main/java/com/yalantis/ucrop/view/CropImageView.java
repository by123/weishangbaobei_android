...
public class CropImageView extends TransformImageView {
    ...
    private void setupInitialImagePosition(float f, float f2) {
        ...
        this.mCurrentImageMatrix.postTranslate(((width - (f * max)) / 2.0f) + f3, ((height - (f2 * max)) / 2.0f) + f4);
    ...
    public void setImageToWrapCropBounds(boolean z) {
        ...
        if (this.mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (isImageWrapCropBounds) {
                ...
                centerY = -(calculateImageIndents[3] + calculateImageIndents[1]);
            ...
            if (z) {
                WrapCropBoundsRunnable wrapCropBoundsRunnable = new WrapCropBoundsRunnable(this, this.mImageToWrapCropBoundsAnimDuration, f, f2, centerX, centerY, currentScale, max, isImageWrapCropBounds);
