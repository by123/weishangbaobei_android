...
public class OverlayView extends View {
    ...
    public void setupCropBounds() {
        ...
        if (i > this.mThisHeight) {
            ...
            this.mCropViewRect.set((float) (getPaddingLeft() + i3), (float) getPaddingTop(), (float) (i2 + getPaddingLeft() + i3), (float) (getPaddingTop() + this.mThisHeight));
        } else {
            int i4 = (this.mThisHeight - i) / 2;
            this.mCropViewRect.set((float) getPaddingLeft(), (float) (getPaddingTop() + i4), (float) (getPaddingLeft() + this.mThisWidth), (float) (i + getPaddingTop() + i4));
        }
        if (this.mCallback != null) {
            this.mCallback.onCropRectUpdated(this.mCropViewRect);
        }
