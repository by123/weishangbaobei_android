    ...
    private static InetAddress decodeIpv6(String str, int i, int i2) {
        ...
        while (true) {
            if (i6 >= i2) {
                ...
                int i7 = i6 + 2;
                if (i7 > i2 || !str.regionMatches(i6, "::", 0, 2)) {
                    if (i5 != 0) {
                        if (str.regionMatches(i6, ":", 0, 1)) {
                            ...
                            if (!decodeIpv4Suffix(str, i3, i2, bArr, i5 - 2)) {
                                return null;
                            }
                            i5 += 2;
                        }
        ...
        if (i5 != bArr.length) {
            ...
            int i13 = i5 - i4;
            System.arraycopy(bArr, i4, bArr, bArr.length - i13, i13);
            Arrays.fill(bArr, i4, (bArr.length - i5) + i4, (byte) 0);
        }
        try {
